...
`CI=true npm run build` currently exits **1** with **250 warnings** across 36
...
|---|---:|---|
| Frozen donor debt (`src/App.js`) | 135 | CLAUDE.md freezes the file; CRA deletion is scheduled post-Sprint-2 |
