...
| DL-010 | **Intelligence Engine Doctrine** governs all intelligence/engine work — engine tiers, canonical sources, CTA contract, pre-coding audit matrix, kill/park rules. See [INTELLIGENCE_ENGINE_DOCTRINE.md](INTELLIGENCE_ENGINE_DOCTRINE.md) | **Doctrine** | DOCTRINE-INTEL-1 (2026-07-06) | PROGRESS-1/2 source-of-truth locks; CTA-REPAIR-1 routing contract; audience whitelists (Vendor Brief/RSVP/rain) | ALL |
