...
const bridalShower = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host makes the spread', 'Caterer / tea service', 'Potluck', 'Restaurant'], default: 'Host makes the spread', when: 'T-21d', blocks: ['food', 'vendors'], costFactors: { 'Caterer / tea service': 1.35, 'Potluck': 0.55, 'Restaurant': 1.4 }, costFactorProvenance: { tier: 'synthesized', confidence: 'medium', verificationStatus: 'synthesized', note: 'Cost factor heuristics need verification against actual pricing.', claim: 'Hiring a caterer/tea service adds ~35% to per-guest food cost, potluck reduces it ~45%, and a restaurant adds ~40% vs. host-made brunch', sufficientWhen: 'catering, tea service, and restaurant price quotes compared against grocery cost for equivalent host-made brunch confirm the cost-factor ratios' }, affects: ['p_food'], weight: 'high', reversibility: 'costly', emotionalWeight: 'low', difmCapable: 'can-derive', priorityBasis: { rationale: 'How the food is handled — a host spread, caterer, or restaurant; a real cost call, but a host-made brunch is a safe default the app can set.', tier: 'reasoned' }, why: 'A shower spread is host-friendly; a caterer or restaurant suits a larger or fancier one.' },
