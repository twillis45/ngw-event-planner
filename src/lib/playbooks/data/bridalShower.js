...
const bridalShower = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host makes the spread', 'Caterer / tea service', 'Potluck', 'Restaurant'], default: 'Host makes the spread', when: 'T-21d', blocks: ['food', 'vendors'], costFactors: { 'Caterer / tea service': 1.35, 'Potluck': 0.55, 'Restaurant': 1.4 }, affects: ['p_food'], why: 'A shower spread is host-friendly; a caterer or restaurant suits a larger or fancier one.' },
