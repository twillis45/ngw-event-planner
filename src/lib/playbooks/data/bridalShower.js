...
const bridalShower = {
  ...
  purchases: [
    ...
    { id: 'p_punch', item: 'Non-alcoholic punch / mocktail base + garnishes', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Grocery'], unitCostRange: [1, 3], essential: true, buyAt: 'T-3d', note: 'Always offer a great zero-proof punch for non-drinkers — make it as pretty as the mimosa bar.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_paper', item: 'Paper goods (tablecloths, foil, leftover + gift-haul bags)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Costco'], unitCostRange: [8, 20], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: a bag/bin to carry the gift haul home for the bride.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_cleanup', item: 'Trash + recycling bags, paper towels, wipes', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [8, 14], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
