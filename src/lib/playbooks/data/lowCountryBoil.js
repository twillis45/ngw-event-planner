...
const lowCountryBoil = {
  ...
  purchases: [
    ...
    { id: 'p_ice', item: 'Ice (drinks + coolers)', category: 'beverage', qtyPerGuest: 1.5, unit: 'lb', where: ['Grocery', 'Gas station'], unitCostRange: [0.2, 0.4], essential: true, buyAt: 'T0', note: 'COMMONLY FORGOTTEN. ~1.5 lb/guest to keep beer and tea cold all afternoon.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_cleanup', item: 'Heavy trash bags, paper towels, foil for leftovers', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Hardware store'], unitCostRange: [8, 16], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: heavy bags hold the wet shell-filled paper without tearing. Foil to wrap leftovers.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
