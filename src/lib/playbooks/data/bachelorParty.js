...
const bachelorParty = {
  ...
  purchases: [
    ...
    { id: 'p_decor', item: 'Light decor (sash/hat for the groom, banner)', category: 'decor', qtyFlat: 1, unit: 'kit', where: ['Party store', 'Amazon'], unitCostRange: [10, 30], essential: false, buyAt: 'T-3d', note: 'Keep it tasteful and groom-approved — a hat or sash, not a whole theme.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
