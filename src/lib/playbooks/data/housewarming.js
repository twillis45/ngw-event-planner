...
const housewarming = {
  ...
  purchases: [
    ...
    { id: 'p_veg', item: 'Crudité veg + a dip or two (hummus/ranch)', category: 'food', qtyPerGuest: 0.2, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 3], essential: true, buyAt: 'T-1d', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: 'The easy, healthy, allergy-friendly portion of the spread.' } },
    { id: 'p_passed', item: 'Passed/snack bites (nuts, chips + salsa, popcorn, a warm dip)', category: 'food', qtyPerGuest: 2, unit: 'bites', where: ['Grocery', 'Trader Joe\'s'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-3d', note: 'Targets the ~6-8 bites/guest/hour rule across the whole spread; scatter bowls along the tour path.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: 'US hosting rule of thumb: ~6-8 app bites/guest/hour for an apps-only party; the board + these bowls together hit that.' } },
    { id: 'p_sweet', item: 'Something sweet (cookies, brownies, a small cake)', category: 'food', qtyPerGuest: 1, unit: 'piece', where: ['Bakery', 'Grocery'], unitCostRange: [1, 3], essential: false, buyAt: 'T-1d', provenance: { tier: 'host-coaching', confidence: 'low', verificationStatus: 'synthesized', note: 'A small sweet closes the spread; optional for a casual drop-in.' } },
