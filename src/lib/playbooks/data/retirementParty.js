...
const retirementParty = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host cooks', 'Drop-off catering / buffet', 'Restaurant', 'Potluck'], default: 'Drop-off catering / buffet', when: 'T-21d', blocks: ['food', 'vendors'], costFactors: { 'Host cooks': 0.7, 'Restaurant': 1.15, 'Potluck': 0.55 }, affects: ['p_buffet_protein', 'p_sides', 'p_apps'], why: 'A buffet drop-off keeps the host present for the tributes instead of in the kitchen.' },
