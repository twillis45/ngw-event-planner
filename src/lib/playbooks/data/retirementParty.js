...
const retirementParty = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host cooks', 'Drop-off catering / buffet', 'Restaurant', 'Potluck'], default: 'Drop-off catering / buffet', when: 'T-21d', blocks: ['food', 'vendors'], why: 'A buffet drop-off keeps the host present for the tributes instead of in the kitchen.' },
