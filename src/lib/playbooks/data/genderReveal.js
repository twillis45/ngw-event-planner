...
const genderReveal = {
  ...
  cookLever: { decision: 'food_style', hostCooks: ['Host makes finger food'], kind: 'indoor' },
  meta: {
    summary:
  ...
  purchases: [
    ...
    { id: 'p_fire_safety', item: 'Fire extinguisher / bucket of water on hand (if any outdoor reveal)', category: 'logistics', qtyFlat: 1, unit: 'unit', where: ['Hardware store', 'Already own'], unitCostRange: [0, 40], essential: false, buyAt: 'T-3d', note: 'Cheap insurance even for safe methods; keep nearby if outdoors.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['extinguisher-retail-2026', 'firstaid-retail-2026'], lastVerified: '2026-08-18', claim: 'A precaution whose floor is genuinely zero. A bucket of water costs nothing if the host already has a bucket, which is why this band starts at 0; the ceiling is a bought household extinguisher at $27.49-41.49, all 1-A:10-B:C rated. Nothing here prices a Class K unit, which an outdoor reveal does not need.', sufficientWhen: 'One household extinguisher shelf price confirms the ceiling; the floor is the no-purchase case.' }, },
  ],
