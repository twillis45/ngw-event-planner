...
const genderReveal = {
  ...
  purchases: [
    ...
    { id: 'p_mocktail', item: 'Mocktail / pink-or-blue punch mixers (for the parent-to-be)', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Grocery'], unitCostRange: [1, 3], essential: true, buyAt: 'T-3d', note: 'Make the zero-proof option genuinely great — the pregnant guest of honor is the centerpiece.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_softdrinks', item: 'Soft drinks / sparkling water', category: 'beverage', qtyPerGuest: 2, unit: 'cans', where: ['Grocery', 'Costco'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_favors', item: 'Favors (optional — pink/blue treats or "He or She?" trinkets)', category: 'decor', qtyPerGuest: 1, unit: 'favor', where: ['Party store', 'Amazon', 'Etsy'], unitCostRange: [2, 6], essential: false, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_tableware', item: 'Plates, cups, napkins, cutlery (pink + blue)', category: 'rental', qtyPerGuest: 1.5, unit: 'set', where: ['Grocery', 'Party store', 'Costco'], unitCostRange: [0.4, 1.5], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
