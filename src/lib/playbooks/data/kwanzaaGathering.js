...
const kwanzaaGathering = {
  ...
  purchases: [
    ...
    { id: 'p_mains', item: 'Karamu mains — stews / one-pot (gumbo, jollof rice, jerk chicken, oxtail, jambalaya)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Black-owned market', 'Caterer'], unitCostRange: [3, 8], essential: true, buyAt: 'T-1d', note: 'The Karamu spread blends Pan-African, African American Southern, and Caribbean cooking — warming, communal, one-pot dishes that serve a crowd and hold well.', provenance: { tier: 'cultural-tradition', confidence: 'medium', verificationStatus: 'established-consensus', note: 'Karamu menus draw on diaspora one-pot/stew dishes; ~0.5 lb main protein/guest heuristic.' } },
    ...
    { id: 'p_greens', item: 'Collard greens (prosperity)', category: 'food', qtyPerGuest: 0.3, unit: 'lb', where: ['Grocery', 'Farmers market', 'Black-owned market'], unitCostRange: [1, 3], essential: true, buyAt: 'T-1d', note: 'Stewed greens symbolize good fortune/wealth — alongside black-eyed peas, the two most essential Karamu foods.', provenance: { tier: 'cultural-tradition', confidence: 'high', verificationStatus: 'established-consensus', note: 'Collard greens widely documented as an essential Karamu dish.' } },
    { id: 'p_sides', item: 'Sides (rice & peas, candied yams, mac & cheese, cornbread, plantains)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Black-owned market'], unitCostRange: [1, 4], essential: true, buyAt: 'T-1d', note: 'The sides carry the diaspora table — Southern, Caribbean, and West African in one spread.' },
    { id: 'p_dessert', item: 'Dessert (sweet potato pie, peach cobbler, bread pudding)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Grocery', 'Bakery', 'Black-owned bakery'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', note: 'Sweet potato pie is the classic close; a Black-owned bakery is a meaningful (Ujamaa) source.' },
    { id: 'p_drinks', item: 'Drinks (juice, cider, sorrel/hibiscus, water, tea)', category: 'beverage', qtyPerGuest: 3, unit: 'servings', where: ['Grocery', 'Black-owned beverage maker'], unitCostRange: [0.5, 2], essential: true, buyAt: 'T-3d', note: 'Sorrel (hibiscus) is a beloved Caribbean holiday drink and a fitting all-ages option.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~3 drinks/guest over a ~3h indoor gathering.' } },
