...
const juneteenthCookout = {
  ...
  decisions: [
    ...
    { id: 'sourcing', label: 'Where does the spread come from?', options: ['Black-owned restaurants / caterers / bakers where you can', 'Host cooks the mains, supports a Black-owned bakery for the cake', 'Host cooks everything', 'Potluck — guests bring a dish that means something to them'], default: 'Host cooks the mains, supports a Black-owned bakery for the cake', when: 'T-14d', blocks: ['food', 'vendors'], costFactors: { 'Black-owned restaurants / caterers / bakers where you can': 1.35, 'Host cooks everything': 0.9, 'Potluck — guests bring a dish that means something to them': 0.7 }, affects: ['p_ribs', 'p_chicken', 'p_links', 'p_redvelvet'], why: 'Supporting Black-owned businesses is a recognized way to honor the day, and it lifts host load. The red velvet cake / red drink from a Black-owned bakery is an easy, meaningful default.' },
    { id: 'menu', label: 'The cookout spread (mains + sides)', options: ['Ribs + chicken + links + the sides', 'Smoked brisket + chicken + the sides', 'Mixed grill + seafood + the sides', 'Lighter spread: chicken + sides + plenty of red foods'], default: 'Ribs + chicken + links + the sides', when: 'T-14d', blocks: ['food', 'fuel'], costFactors: { 'Smoked brisket + chicken + the sides': 1.2, 'Mixed grill + seafood + the sides': 1.25, 'Lighter spread: chicken + sides + plenty of red foods': 0.75 }, affects: ['p_ribs', 'p_chicken', 'p_links'], why: 'Drives proteins, fuel, and grill/smoke time. The sides carry the table: mac & cheese, baked beans, collard greens, potato salad, cornbread.' },
    { id: 'red_table', label: 'The red foods + "red drink" (the symbolic layer)', options: ['Red drink + watermelon + red velvet cake', 'Hibiscus/sorrel "red drink" from scratch + watermelon + red dessert', 'Big Red / strawberry soda + watermelon + red velvet', 'Full red table: red drink, watermelon, red velvet, red beans, strawberries'], default: 'Red drink + watermelon + red velvet cake', when: 'T-14d', blocks: ['food', 'beverage_purchases'], costFactors: { 'Full red table: red drink, watermelon, red velvet, red beans, strawberries': 1.3 }, affects: ['p_reddrink', 'p_redvelvet', 'p_watermelon', 'p_strawberries', 'p_beans'], why: 'Red foods and drinks are central to Juneteenth — red symbolizes resilience and the blood/sacrifice of the enslaved, and red is a sacred color in West African heritage. At least one red drink + watermelon + a red dessert should be on the table.' },
  ...
  purchases: [
    { id: 'p_ribs', item: 'Pork ribs (racks)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Butcher', 'Black-owned butcher/market', 'Costco'], unitCostRange: [4, 8], sourcingPrices: { butcher: [4, 7], costco: [3, 4], grocery: [5, 8] }, essential: true, buyAt: 'T-1d', whenChoice: { id: 'menu', in: ['Ribs + chicken + links + the sides', 'Mixed grill + seafood + the sides'] }, note: 'A Juneteenth/cookout centerpiece — plan ~1/2 rack of ribs per rib-eater; cuts smoke at ~30-40% weight loss.', alternatives: [{ name: 'Pork shoulder', note: 'cheaper, feeds the same crowd slow-smoked', unitCostRange: [3, 6] }, { name: 'Bone-in chicken thighs', note: 'budget swap, hard to overcook', unitCostRange: [2, 4] }], provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'cited', note: 'Per-channel raw-rib $/lb: Costco ~$3–4, grocery $4–5+, butcher/pre-marinated higher.', sources: ['https://redtablemeats.com/fresh-meat/pork/how-much-are-pork-ribs-at-costco/', 'https://www.eatlikenoone.com/costco-pork-guide.htm'] } },
    { id: 'p_chicken', item: 'BBQ chicken (bone-in pieces)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Butcher', 'Costco'], unitCostRange: [2, 5], sourcingPrices: { butcher: [2, 4], costco: [1, 2.5], grocery: [3, 5] }, essential: true, buyAt: 'T-1d', alternatives: [{ name: 'Chicken drumsticks', note: 'lowest cost per lb, kid-friendly', unitCostRange: [1.5, 3] }, { name: 'Whole chicken cut up', note: 'cheaper per lb than quarters', unitCostRange: [1.5, 3] }], provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'cited', note: 'Per-channel bone-in chicken $/lb: Costco thighs ~$1.79 / drumsticks ~$0.99 / pre-marinated +$0.50; grocery $3–5.', sources: ['https://www.eatlikenoone.com/chicken-prices-at-costco.htm', 'https://costcofdb.com/the-complete-guide-to-costcos-chicken-prices-tips-and-hacks-costco-guides'] } },
    ...
    { id: 'p_reddrink', item: 'Red drink (hibiscus/sorrel, strawberry soda, or punch)', category: 'beverage', qtyPerGuest: 3, unit: 'servings', where: ['Grocery', 'Black-owned beverage maker', 'Make from scratch'], unitCostRange: [0.5, 2], essential: true, buyAt: 'T-3d', badge: 'Tradition', note: 'The red drink is essential to Juneteenth — hibiscus/sorrel ties directly to West African roots. Lead with it for all ages.', provenance: { tier: 'cultural-tradition', confidence: 'high', verificationStatus: 'established-consensus', note: 'Red drink (hibiscus/sorrel, strawberry, Big Red, punch) is a core Juneteenth tradition.' } },
