...
const juneteenthCookout = {
  ...
  purchases: [
    ...
    { id: 'p_redvelvet', item: 'Red velvet cake (the symbolic red dessert)', category: 'food', qtyPerGuest: 1, unit: 'slice', where: ['Black-owned bakery', 'Bakery', 'Grocery'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', note: 'Red velvet carries the resilience/sacrifice symbolism — a natural buy from a Black-owned bakery to honor the day.', alternatives: ['Strawberry cake — still red, budget alternative if red velvet unavailable', 'Grocery red velvet sheet cake — cheaper, still symbolic'], provenance: { tier: 'cultural-tradition', confidence: 'high', verificationStatus: 'established-consensus', note: 'Red velvet is a widely-documented Juneteenth red dessert.' } },
