...
const juneteenthCookout = {
  ...
  tasks: [
    ...
    { id: 't_moment', milestoneId: 'event', phase: 'event', label: 'Before the meal: pause the music, share the Juneteenth history/reflection, then bless the food and eat', when: 'T0 +1:00' },
  ...
  purchases: [
    { id: 'p_ribs', item: 'Pork ribs (racks)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Butcher', 'Black-owned butcher/market', 'Costco'], unitCostRange: [4, 8], essential: true, buyAt: 'T-1d', note: 'A Juneteenth/cookout centerpiece — plan ~1/2 rack of ribs per rib-eater; cuts smoke at ~30-40% weight loss.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~1/2 lb bone-in protein/guest across a multi-protein cookout spread.' } },
    ...
    { id: 'p_links', item: 'Smoked sausage / hot links', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Grocery', 'Butcher', 'Black-owned market'], unitCostRange: [3, 6], essential: true, buyAt: 'T-1d', note: 'Hot links are a Texas Juneteenth staple — the holiday traces to Galveston.' },
  ...
  risks: [
    ...
    { id: 'r_foodsafe', trigger: 'Perishables (potato salad, mac, meats) sit out in the heat', severity: 'high', mitigation: 'Keep cold sides on ice; don\'t leave perishables out >1h above 90°F; grill chicken to 165°F; restock the buffet in waves.' },
