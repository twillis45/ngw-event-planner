...
const crabFeast = {
  ...
  decisions: [
    ...
    { id: 'where_buy', label: 'Where to buy — crab house or market?', options: ['Local crab house', 'Seafood market', 'Waterman / dock direct'], default: 'Local crab house', when: 'T-10d', blocks: ['food'], why: 'A crab house sells live or steamed by the dozen/bushel and knows the day\'s sizes and price; a seafood market is convenient; buying off the dock gets you fresh and local if you have the connection. Call ahead — supply and price swing with the season and the catch.' },
  ...
  purchases: [
    { id: 'p_crabs', item: 'Live or steamed blue crabs (by size — mediums/larges/jumbos)', category: 'food', qtyPerGuest: 9, unit: 'crab', where: ['Local crab house', 'Seafood market', 'Waterman / dock'], unitCostRange: [2.5, 7], essential: true, buyAt: 'T0', note: 'THE meal. Sold by the dozen or bushel and by size; price is live, seasonal, and swings with the catch — call ahead. ~6–12 crabs per adult picker; a bushel is ~5–7 dozen and feeds ~8–12. Steamed-for-pickup costs more but saves the pot.', provenance: { tier: 'regional-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: 'Maryland crab-feast norm of ~6–12 crabs/adult picker and a bushel feeding ~8–12; per-crab cost varies widely by size and season.' } },
    ...
    { id: 'p_corn', item: 'Corn on the cob', category: 'food', qtyPerGuest: 1.2, unit: 'ear', where: ['Grocery', 'Farm stand'], unitCostRange: [0.4, 0.9], essential: true, buyAt: 'T-1d', note: 'The constant side. Summer sweet corn, steamed or boiled, then hit with Old Bay and butter.' },
    ...
    { id: 'p_sides', item: 'Coleslaw, potato salad, hush puppies', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Deli'], unitCostRange: [1.5, 4], essential: true, buyAt: 'T-3d', note: 'Cabbage/carrot for slaw, potatoes for salad; hush puppies optional. Make slaw and potato salad a day ahead so the crab day is simple.' },
