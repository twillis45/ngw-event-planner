...
const crabFeast = {
  ...
  purchases: [
    ...
    { id: 'p_corn', item: 'Corn on the cob', category: 'food', qtyPerGuest: 1.2, unit: 'ear', where: ['Grocery', 'Farm stand'], unitCostRange: [0.4, 0.9], essential: true, buyAt: 'T-1d', note: 'The constant side. Summer sweet corn, steamed or boiled, then hit with Old Bay and butter.', alternatives: ['Frozen corn on the cob — cheaper out of season, works fine in the pot'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
