...
const crabFeast = {
  ...
  purchases: [
    ...
    { id: 'p_towels', item: 'Paper towels (rolls) + wet wipes', category: 'cleanup', qtyPerGuest: 0.5, unit: 'roll', where: ['Grocery', 'Costco/Sam\'s'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', note: 'A roll stood up on every table is part of the setup — crab picking is gloriously messy. Wet wipes for hands.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
