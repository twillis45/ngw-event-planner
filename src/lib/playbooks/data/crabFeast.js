...
const crabFeast = {
  ...
  purchases: [
    { id: 'p_crabs', item: 'Blue crabs — live or steamed (sold by the dozen or bushel)', category: 'food',
      ...
      note: "THE meal. For any real group, buy by the bushel — it is the natural purchase unit, cheaper per crab, and how dealers think. A full bushel of Large Males (~72 crabs) feeds ~12–15 adults with sides; a half bushel (~36 crabs) feeds ~6–8. Quantity depends on crab size: larger crabs = fewer per person AND fewer per bushel. See servingGuide.bySize for per-size counts and buyingUnits for the arithmetic. Adult pickers only — kids need a separate count or an alternative food. Large Male prices vary: Captain White's $72/dz, Don's $95/dz, Blue Crab House $98/dz — call two dealers before ordering.", provenance: { tier: 'primary', confidence: 'high', verificationStatus: 'cited', sources: ["Captain White's Seafood (Oxon Hill, MD — LEFT the Maine Ave Fish Market in Nov 2021) — July 2–4 2026. 202-554-5520", "Don's Crabs and Seafood (Maryland) — donscrabsandseafood.com/crab-prices/, as of 2026-07-03", "Blue Crab House (Maryland) — bluecrabhouse.com/crabs/, as of 2026-07-03", "Cameron's Seafood — cameronsseafood.com/collections/maryland-blue-crabs, as of 2026-07-03"], note: "Large Male per-dozen July 2026: Captain White's $72, Cameron's ~$80, Don's $95, Blue Crab House $98. Captain White's is notably on the lower end — local crab houses and watermen vary widely. unitCostRange [32,188] spans Medium at Captain White's to Jumbo Males at Blue Crab House.", researchedAt: '2026-07-03', claim: "DMV Large Male blue crab retail price range July 2026: $72–98/dz depending on vendor. Full market range from Mediums ($32/dz) to Jumbo Males ($175–188/dz).", sufficientWhen: "Four DMV retail sources confirmed July 2026 — additional waterman or dock-direct quotes would complete the low end" }, costProvenance: { tier: 'researched', confidence: 'high', verificationStatus: 'cited', sources: ['dmv-crab-2026', 'crabs-buylivecrab-2026'], lastVerified: '2026-08-18', claim: "Same DMV crab-house survey as the quantity provenance above, now wired into the registry-based cost slot: four named dealers (Captain White's, Don's, Blue Crab House, Cameron's) span $32-188/dz by size. A fifth independent national source, BuyLiveCrab.com, corroborates at $4.25/lb (45lb minimum) — a different unit but the same commodity class.", sufficientWhen: 'Confirmed — five independent named sources.' }, alternatives: ['Steamed shrimp — far cheaper per lb, same Old Bay treatment', 'Snow crab clusters (frozen) — available year-round, no live crab sourcing'] },
    { id: 'p_oldbay', item: 'Old Bay (or J.O.) seasoning — buy extra', category: 'food', qtyPerGuest: 0.05, unit: 'lb', where: ['Grocery', 'Crab house', 'Restaurant supply'], unitCostRange: [4, 9], essential: true, buyAt: 'T-3d', note: 'The identity of the table. Heavy on every layer when steaming AND extra to dust on top and on the shrimp/corn. Buy more than you think — people re-season as they pick.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['seasoning-bulk-2026', 'spicerack-bulk-2026'], lastVerified: '2026-08-18', claim: 'Crab seasoning per pound, AT THE SIZE THIS ROW BUYS. A 6oz supermarket tin works out to about $15.97/lb and is not what \'buy extra\' means. At the sizes a crab feast actually purchases: Old Bay 24oz is $10.00-13.95 ($6.67-9.30/lb) and a 7.5lb jug $39.49 ($5.27/lb); J.O. No. 2 in a 5lb container is $21.49 ($4.30/lb), with a 32oz consumer bottle at $5.90/lb. Those bracket this band. Note a 6-per-case of 24oz works out to $11.10/lb - DEARER than a single unit, so case buying is not automatically cheaper.', sufficientWhen: 'A 24oz container price and a 5lb bulk price, each divided per pound, confirm both ends.' }, },
    { id: 'p_vinegar', item: 'Apple-cider vinegar (steam liquid + dipping)', category: 'food', qtyFlat: 1, unit: 'gal', where: ['Grocery'], unitCostRange: [3, 7], essential: true, buyAt: 'T-3d', note: 'Half the steam liquid (with water and/or beer) and also poured into dipping dishes. Vinegar softens the shells and cuts the richness.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['vinegar-hotsauce-oil-2026', 'seasoning-bulk-2026'], lastVerified: '2026-08-18', claim: 'Apple cider vinegar by the gallon. A house-brand gallon is $5.99 ($0.047 a fluid ounce), which is this band; Heinz at the same size is $19.11-23.49 ($0.149-0.184) and sits well above it. THE 4x SPREAD IS BRAND, not size - both are one-gallon jugs - so the band prices the house brand a boil actually buys by the gallon.', sufficientWhen: 'A house-brand and a name-brand gallon price, side by side, confirm which this band covers.' }, },
    { id: 'p_butter', item: 'Butter (for melting) + dipping dishes', category: 'food', qtyPerGuest: 0.1, unit: 'lb', where: ['Grocery'], unitCostRange: [3.5, 5.5], essential: true, buyAt: 'T-1d', note: 'Melted butter is the dip alongside the vinegar — small bowls down the table.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['butter-bls-2026', 'butter-retail-2026'], lastVerified: '2026-08-18', claim: 'Stick butter, per pound: BLS national average $4.314/lb; Walmart/Kroger retail $4.46-5.49/lb. Band raised 2026-08-18 to $3.50-5.50/lb to match — the old $1-2.50 band sat below the commodity nationally.', sufficientWhen: 'Confirmed — BLS and two retailers converge tightly.' } },
    { id: 'p_corn', item: 'Corn on the cob', category: 'food', qtyPerGuest: 1.2, unit: 'ear', where: ['Grocery', 'Farm stand'], unitCostRange: [0.4, 0.9], essential: true, buyAt: 'T-1d', note: 'The constant side. Summer sweet corn, steamed or boiled, then hit with Old Bay and butter.', alternatives: ['Frozen corn on the cob — cheaper out of season, works fine in the pot'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['corn-farm-2026', 'corn-retail-2026'], lastVerified: '2026-08-18', claim: 'Corn on the cob 2026. A university farm market at harvest sold ears at $0.37 (down from $0.49 in 2025); Walmart lists single ears about $0.50, with recent listings $0.68-0.77; the national average is $0.50-1.25 per cob depending on season and region, cheapest at peak harvest from late July through August. This band is a summer ear bought in quantity.', sufficientWhen: 'One per-ear shelf price in season and one out of season confirm both ends of the band.' }, },
    { id: 'p_shrimp', item: 'Steamed shrimp (Old Bay)', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Seafood market', 'Crab house', 'Grocery'], unitCostRange: [8, 14], essential: false, buyAt: 'T0', note: 'The classic seafood add-on, steamed in Old Bay like the crabs — order with the crabs or steam your own.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['shrimp-market-2026', 'usda-meat-2026'], lastVerified: '2026-08-18', claim: 'Shrimp priced per pound, steamed. The raw commodity is $8.46/lb as of June 2026; steaming to order at a seafood counter or market adds to that, which is where the band\'s ceiling comes from. Old Bay for the steam is priced on its own row, not this one.', sufficientWhen: 'One raw per-pound price and one steamed-to-order counter price confirm both ends of the band.' }, },
    { id: 'p_sides', item: 'Coleslaw, potato salad, hush puppies', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Deli'], unitCostRange: [1.5, 4], essential: true, buyAt: 'T-3d', note: 'Cabbage/carrot for slaw, potatoes for salad; hush puppies optional. Make slaw and potato salad a day ahead so the crab day is simple.', alternatives: ['Deli coleslaw + potato salad — if time is short', 'Bag of chips — cheapest side if budget is very tight'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['bls-produce-2026', 'usda-feature-produce-2026', 'bls-staples-2026'], lastVerified: '2026-08-18', claim: 'Cold sides priced per pound. POTATO SALAD takes white potatoes at $0.94/lb per BLS plus eggs at $2.14 a dozen and mayonnaise at $2.34-3.64 for 30oz. COLESLAW takes green cabbage, advertised nationally at $0.70/lb and shelf-priced at $0.81/lb. HUSH PUPPIES are a cornmeal mix. Prepared deli versions of all three cost several times the ingredient sum, which is where the band\'s ceiling comes from - the floor is making them.', sufficientWhen: 'Ingredient costs for one batch of each against a deli per-pound price confirm the span.' }, },
    { id: 'p_beer', item: 'Cold beer (Natty Boh / local lager)', category: 'beverage', qtyPerGuest: 3, unit: 'beer', where: ['Liquor store', 'Grocery', 'Beer distributor'], unitCostRange: [1, 2.5], essential: false, buyAt: 'T-3d', note: 'The crab-feast drink. National Bohemian ("Natty Boh") is the DMV can; a light lager is right with the seasoning. Skip for a dry feast.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['beer-retail-2026', 'beer-budget-2026'], lastVerified: '2026-08-16', claim: 'Beer at retail 2026: domestic lager $0.80-1.20 per 12oz, or about $20-22 a 24-pack in many states, with value brands at $15-20 a 30-pack; craft runs $1.50-3.00 per 12oz and roughly 1.5-2x domestic at the same pack size; imports $1.20-2.50. Both sources state these are ranges rather than confirmed year-end prices.', sufficientWhen: 'Current shelf prices for one domestic 24-pack and one craft 12-pack at the same store confirm the per-unit range.' } },
    { id: 'p_softdrinks', item: 'Soda, water, iced tea', category: 'beverage', qtyPerGuest: 3, unit: 'drinks', where: ['Grocery', 'Costco/Sam\'s'], unitCostRange: [0.4, 1.2], essential: true, buyAt: 'T-3d', note: 'For kids and non-drinkers and to keep everyone hydrated through a long, salty afternoon.', provenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'researched', sources: ['bar-provision-2026'], note: 'Grounded to bar-provision-2026: ~2–3 non-alcoholic servings/guest (when alcohol is also offered) is the source-stated rate.', claim: 'Guests consume ~3 non-alcoholic drinks each over a 4-hour crab feast afternoon', sufficientWhen: 'Verified against beverage consumption norms for a 4h outdoor summer food event where beer is the primary alcoholic option' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['soda-12pack-2026', 'bottledwater-case-2026', 'icedtea-lemonade-2026'], lastVerified: '2026-08-18', claim: 'Bulk components 2026, each cited to its own registered source: a 12-pack of soda is $3.00-6.50, i.e. $0.25-0.60 a can (average $0.38); bottled water in a 24-pack is $0.13-0.25 a bottle for basic brands; ready-to-drink iced tea and lemonade by the gallon are $3.28-4.48, i.e. $0.21-0.28 per 8oz cup. The band\'s floor is warehouse-channel water and its ceiling is a premium or single-serve can. A SUM of separately-priced components, not one quoted item.', sufficientWhen: 'Current shelf prices for one soda 12-pack, one 24-pack of water and one gallon of tea at the same store, divided to per-serving, confirm the band.' }, },
    { id: 'p_ice', item: 'Ice (coolers + drinks)', category: 'beverage', qtyPerGuest: 2, unit: 'lb', where: ['Grocery', 'Gas station', 'Ice house'], unitCostRange: [0.2, 0.4], essential: true, buyAt: 'T0', note: 'COMMONLY UNDER-BOUGHT. A hot afternoon and a lot of cans/bottles — ~2 lb/guest for drinks and coolers.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['ice-retail-2026', 'ice-warehouse-2026'], lastVerified: '2026-08-16', claim: 'Bagged ice 2026: warehouse clubs run 10-12c per pound (a 20lb bag is $1.75-2.50 at Sams Club, $1.80-2.50 at Costco); grocery and gas-station bags cluster 23-31c/lb (BJs and 7-Eleven 20lb about $4.49-4.79, Giant 20lb $4.99, Publix 16lb $4.99); small bags and hardware stores reach 41-45c/lb. Convenience ice is more than four times warehouse ice per pound.', sufficientWhen: 'Current shelf prices for one 20lb bag at a warehouse club and one at a grocery store confirm the per-pound spread.' } },
    { id: 'p_paper', item: 'Newspaper / brown kraft paper table cover', category: 'decor', qtyFlat: 1, unit: 'roll', where: ['Hardware store', 'Party store', 'Online'], unitCostRange: [8, 20], essential: true, buyAt: 'T-3d', note: 'The signature table. Cover every table thick — at the end you roll the whole mess (shell, paper, scraps) straight into the trash.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['kraft-consumer-2026', 'newsprint-2026'], lastVerified: '2026-08-18', claim: 'A table-cover roll at the CONSUMER grade a host buys. Natural-brown kraft is $5.99 for a 48in x 25ft roll and $24.99 for 12in x 100ft - about $0.24-0.25 a linear foot either way, though the widths differ fourfold and the 48in roll is what covers a crab table. Newsprint rolls are far cheaper per foot ($0.025) but come in 1,200-1,440ft lengths costing $30.99-35.49, a different purchase entirely. The 40lb bleached-white foodservice roll is about a quarter the consumer rate per foot and is not sold in host quantities.', sufficientWhen: 'One consumer kraft roll price, with its width and length, confirms the band.' }, },
    { id: 'p_tools', item: 'Wooden mallets + crab knives', category: 'rental', qtyPerGuest: 1, unit: 'set', where: ['Crab house', 'Hardware store', 'Restaurant supply', 'Online'], unitCostRange: [1, 4], essential: true, buyAt: 'T-3d', note: 'A mallet and a crab knife per picker (and a few spares). Crab houses sell cheap mallets by the bag.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['mallets-foodservice-2026', 'mallets-seafood-2026'], lastVerified: '2026-08-18', claim: 'Plain wooden crab mallets. $1.75 each at a Maryland crab-seasoning house and $2.39 each single or $1.78 at 24+ from foodservice supply. CUSTOM SCREEN-PRINTED MALLETS ARE A SEPARATE TIER and are excluded - a printed mallet runs about $3.99. Crab knives alongside the mallet are not separately priced and are why the band\'s ceiling sits above the mallet figures.', sufficientWhen: 'A per-mallet price at single and at 24-count, plus a crab knife price, confirm the band.' }, },
    { id: 'p_towels', item: 'Paper towels (rolls) + wet wipes', category: 'cleanup', qtyPerGuest: 0.5, unit: 'roll', where: ['Grocery', 'Costco/Sam\'s'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', note: 'A roll stood up on every table is part of the setup — crab picking is gloriously messy. Wet wipes for hands.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['costco-cleaning-2026', 'trashbags-retail-2026'], lastVerified: '2026-08-16', claim: 'Cleanup supplies at warehouse pricing: 13-gallon trash bags about 10 cents each (200 for $20.42), paper towels about $1.97 a roll, dish soap with two refills $14.74, 24 sponges $12.47; the same bags run 11-15 cents each at grocery and big-box.', sufficientWhen: 'Current shelf prices for trash bags and paper towels at one warehouse club and one grocery store confirm the per-unit figures.' } },
    { id: 'p_bibs', item: 'Crab/seafood bibs (optional)', category: 'decor', qtyPerGuest: 1, unit: 'bib', where: ['Crab house', 'Party store', 'Online'], unitCostRange: [0.2, 0.6], essential: false, buyAt: 'T-3d', note: 'Fun, not required — keeps butter and Old Bay off shirts.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['bibs-foodservice-2026', 'bibs-consumer-2026'], lastVerified: '2026-08-18', claim: 'Disposable crab bibs, and this band sits BETWEEN two real channels. Foodservice bulk is $0.11 a bib (Royal Paper poly crab bib, 500 a box at $54.49); a consumer 5-pack is $6.99, about $1.40 a bib - roughly 13x the bulk rate. A host buying a mid-sized party pack lands between the two, which is this band; buying a case would sit below it and a 5-pack above it.', sufficientWhen: 'One 500-count case price and one small retail pack price, each divided per bib, confirm the two channels this band sits between.' }, },
    { id: 'p_tableware', item: 'Disposable plates, bowls, cups, napkins', category: 'rental', qtyPerGuest: 1.5, unit: 'set', where: ['Grocery', 'Costco/Sam\'s', 'Party store'], unitCostRange: [0.25, 2.5], essential: true, buyAt: 'T-3d', note: 'Sturdy plates for sides; small bowls for butter/vinegar. Most picking happens right on the paper.' , costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['disposables-bulk-2026', 'disposables-partyqty-2026'], lastVerified: '2026-08-15', claim: 'A per-guest place setting runs $0.25-2.50 depending entirely on channel: bulk restaurant supply puts plates at $0.08-0.15 each and foam at $0.09, a grocery shelf puts the same basic paper plate at $0.25-0.40, and premium plastic or compostable runs $0.15-0.35 per plate. A setting is 2-3 plates, 2-3 cups, cutlery and 2-3 napkins.', sufficientWhen: 'Re-checked against per-plate pricing and place-setting norms. A deep bulk buy lands near the floor and premium or compostable near the ceiling - the 12x spread is the CHANNEL, not uncertainty. Add 10-15% for spills and unexpected guests. Sets that bundle flutes, koozies, linens or table covers are a different product and are priced separately.' } },
    { id: 'p_cleanup', item: 'Heavy trash bags (double-bag the shell) + shell bucket', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Hardware store'], unitCostRange: [8, 16], essential: true, buyAt: 'T-3d', note: 'COMMONLY UNDERESTIMATED. Crab shell is heavy, wet, and smells fast — contractor-grade bags, double-bagged, and a shell bucket on the table so scraps don\'t pile.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['cleanup-heavyduty-2026', 'homesetup-retail-2026'], lastVerified: '2026-08-18', claim: 'Heavy bags and shell buckets, summed. DOUBLE-BAGGING SHELLS NEEDS A TRUE 3-MIL BAG at $0.62-1.15 each, not a kitchen liner - consumer flap-tie bags sold as \'contractor\' do not state their mil. A 5-gallon consumer plastic bucket is $5-6 each. Two buckets and a run of heavy bags brackets this band.', sufficientWhen: 'A 3-mil bag case divided per bag, plus two consumer buckets, confirm the band.' }, },
  ],
