...
const crabFeast = {
  ...
  decisions: [
    ...
    { id: 'dietary', label: 'Ask your guests about shellfish allergies', options: ['Shellfish', 'Nut allergy', 'Gluten-free', 'Dairy-free', 'Vegetarian', 'Vegan', 'Halal', 'Kosher', 'Alcohol-free'], default: null, when: 'T-10d', blocks: ['food'], noCostEffect: true, why: 'The whole menu is shellfish. One guest with an allergy needs a separate plate kept away from the crab steam and the tools — and you need to know that BEFORE you order the crabs, not while you are steaming them. Your invite asks every guest; this is where their answers land.' },
  ...
  purchases: [
    { id: 'p_crabs', item: 'Blue crabs — live or steamed (sold by the dozen or bushel)', category: 'food', qtyPerGuest: 0.75, unit: 'dozen', where: ["Captain White's Seafood (Maine Ave Fish Market, DC Wharf)", 'Local crab house', 'Seafood market', 'Waterman / dock'], unitCostRange: [32, 188], essential: true, buyAt: 'T0',
      priceLadder: {
        source: "Captain White's Seafood, Maine Ave Fish Market (DC Wharf) — July 2–4 2026",
      ...
      servingGuide: {
        sources: ["Cameron's Seafood blog — cameronsseafood.com/blog/crab-how-tos/how-much-crab-should-i-order/", "Crab Dynasty seafood ordering guide — crabdynasty.com/how-to-order-the-right-amount-of-seafood.html"],
        note: "Ranges are for adult pickers. Lower end = sides are plentiful; upper end = crabs are the main/only dish. For larger groups always buy by the bushel — cheaper per crab and the natural purchase unit.",
        bySize: {
          medium:   { withSides: 6, mainOnly: 8 },
          large:    { withSides: 5, mainOnly: 6 },
          xl:       { withSides: 4, mainOnly: 6 },
          jumbo:    { withSides: 3, mainOnly: 5 },
          colossal: { withSides: 3, mainOnly: 4 },
        },
        children: { under10: 2, note: "Kids typically eat 1–2 regardless of size; plan 1–2 per child or a kid-friendly alternative" },
        buyingUnits: {
          note: "Buy by the dozen for ≤2 adult pickers; half bushel for 4–8; full bushel for 8–15; multiple bushels above 15.",
          largeMaleExample: "15 adults × 5 crabs (with sides) = 75 crabs ÷ 72 per bushel = ~1 full bushel of Large Males ($345 at Captain White's vs $450 at Captain Dan's)",
        },
      },
      marketComps: [
        {
