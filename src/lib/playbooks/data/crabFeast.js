...
const crabFeast = {
  ...
  purchases: [
    ...
    { id: 'p_butter', item: 'Butter (for melting) + dipping dishes', category: 'food', qtyPerGuest: 0.1, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 2.5], essential: true, buyAt: 'T-1d', note: 'Melted butter is the dip alongside the vinegar — small bowls down the table.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
