...
const crabFeast = {
  ...
  purchases: [
    ...
    { id: 'p_tools', item: 'Wooden mallets + crab knives', category: 'rental', qtyPerGuest: 1, unit: 'set', where: ['Crab house', 'Hardware store', 'Restaurant supply', 'Online'], unitCostRange: [1, 4], essential: true, buyAt: 'T-3d', note: 'A mallet and a crab knife per picker (and a few spares). Crab houses sell cheap mallets by the bag.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_bibs', item: 'Crab/seafood bibs (optional)', category: 'decor', qtyPerGuest: 1, unit: 'bib', where: ['Crab house', 'Party store', 'Online'], unitCostRange: [0.2, 0.6], essential: false, buyAt: 'T-3d', note: 'Fun, not required — keeps butter and Old Bay off shirts.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
