...
const crabFeast = {
  ...
  purchases: [
    { id: 'p_crabs', item: 'Live or steamed blue crabs (by size — mediums/larges/jumbos)', category: 'food', qtyPerGuest: 9, unit: 'crab', where: ['Local crab house', 'Seafood market', 'Waterman / dock'], unitCostRange: [2.5, 9], essential: true, buyAt: 'T0', note: 'THE meal. Sold by the dozen or bushel and by size; price is live, seasonal, and swings with the catch — call ahead. ~6–12 crabs per adult picker; a bushel is ~5–7 dozen and feeds ~8–12. Steamed-for-pickup costs more but saves the pot — Jessie Taylor or Captain White\'s at the DC Wharf will steam your bushel in ~25 min while you wait.', provenance: { tier: 'researched', confidence: 'high', verificationStatus: 'researched', sources: ['donscrabsandseafood.com/crab-prices/', 'bluecrabhouse.com/crabs/', 'news.maryland.gov/dnr/2025/05/22/...'], note: 'Per-crab retail range July 2026: smalls $3.75–4.00, mediums $6.17–6.25, larges $7.92–8.17 (default choice). Range floor: dock-direct/cold pickens $2.00–2.50. Range ceiling: $9 captures retail large males at peak supply-constrained season (2025 Chesapeake harvest 238M crabs, 2nd lowest since 1990). Previous range [2.5,7] understated larges by ~$1/crab.', researchedAt: '2026-07-02' }, alternatives: ['Steamed shrimp — far cheaper per lb, same Old Bay treatment', 'Snow crab clusters (frozen) — available year-round, no live crab sourcing'] },
