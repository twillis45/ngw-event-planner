...
const theCookout = {
  ...
  purchases: [
    ...
    { id: 'p_potato_salad', item: 'Potato salad ingredients', category: 'food', qtyPerGuest: 0.35, unit: 'lb', where: ['Grocery'], unitCostRange: [1.5, 3], essential: true, buyAt: 'T-2d', note: 'Claimed by the trusted hands — assign it to the one person whose potato salad everybody actually eats.', alternatives: ['Deli potato salad — if the trusted hands aren\'t available', 'Macaroni salad — similar cold starch role, easier to make in bulk'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
