...
const theCookout = {
  ...
  purchases: [
    ...
    { id: 'p_mac', item: 'Baked mac & cheese ingredients (or pans)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery'], unitCostRange: [2, 4], essential: true, buyAt: 'T-2d', note: 'Baked, not stovetop — this is a flagship side, not a filler.', alternatives: ['Store-bought baked mac pan (Costco/Walmart) — if time is short', 'Stovetop mac & cheese — faster but not the same; last resort only'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_comfort', item: 'Bug spray, citronella, sunscreen, paper towels', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Pharmacy'], unitCostRange: [15, 35], essential: false, buyAt: 'T-3d', note: 'All-day outdoors — sun and mosquitoes run people off. Keep the elders comfortable.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
