...
const theCookout = {
  ...
  purchases: [
    ...
    { id: 'p_cornbread', item: 'Cornbread', category: 'food', qtyPerGuest: 1, unit: 'piece', where: ['Grocery', 'Bakery'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-1d', alternatives: ['Store-bought cornbread mix (Jiffy) — quick bake, feeds same crowd', 'Dinner rolls — if cornbread is sold out'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_soda_water', item: 'Soda + bottled water', category: 'beverage', qtyPerGuest: 3, unit: 'drinks', where: ['Grocery', 'Costco'], unitCostRange: [0.4, 1], essential: true, buyAt: 'T-3d', note: 'Plenty of water for the heat — non-negotiable for an all-day outdoor function.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
