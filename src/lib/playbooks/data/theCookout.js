...
const theCookout = {
  ...
  decisions: [
    {
      ...
      costFactorProvenance: { tier: 'synthesized', confidence: 'medium', verificationStatus: 'synthesized', note: 'Hiring a pitmaster adds 40% cost. Needs catering service price verification.', claim: 'Hiring a pitmaster adds approximately 40% to total food cost vs using a family grill master', sufficientWhen: '≥2 pitmaster or BBQ catering quotes confirm a premium of ~35–45% over the raw protein cost of a self-run grill' },
    ...
    },
    {
      ...
      costFactorProvenance: { tier: 'synthesized', confidence: 'medium', verificationStatus: 'synthesized', note: 'Host cooking all adds 30% cost; potluck saves 45%. Needs ingredient/labor cost verification.', claim: 'Having the host cook all sides adds ~30% to the food budget vs a split model; a full potluck saves ~45%', sufficientWhen: 'Ingredient cost estimate for a host-cooked full spread vs a potluck spread at same headcount confirms the ~30% and ~45% spread' },
  ...
  purchases: [
    ...
    { id: 'p_grown_folks', item: 'Grown-folks section: brown liquor + mixers, beer', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Liquor store', 'Costco'], unitCostRange: [2, 5], essential: false, buyAt: 'T-3d', note: 'A clearly separate section for the adults — keep it away from the kids\' drink table. ~1 drink/guest/hr is the planning rule.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: '~1 alcoholic drink/guest/hr is the common party-planning rule; scaled for an all-day cookout with a family-friendly majority.', claim: 'Alcoholic drink need at a cookout is ~1 drink/guest/hour, adjusted downward for a family-friendly majority', sufficientWhen: 'Standard US bartending or catering guide confirms the ~1 alcoholic drink/guest/hour rule; a family/adult ratio split is documented in ≥1 source' } },
