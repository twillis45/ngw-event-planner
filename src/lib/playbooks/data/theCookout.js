...
const theCookout = {
  ...
  purchases: [
    ...
    { id: 'p_beans', item: 'Baked beans ingredients', category: 'food', qtyPerGuest: 0.3, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 2.5], essential: true, buyAt: 'T-2d', alternatives: ['Canned baked beans (Bush\'s) — near-zero prep, dress them up with bacon + brown sugar', 'Black-eyed peas — budget swap, takes same pot time'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
