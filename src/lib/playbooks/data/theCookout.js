...
const theCookout = {
  ...
  purchases: [
    { id: 'p_ribs', item: 'Ribs (racks)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Costco', 'Butcher'], unitCostRange: [4, 8], essential: true, buyAt: 'T-1d', note: 'The centerpiece for the grill master. Bone-in runs heavy — plan ~half a rack of appetite per serious eater.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: 'Bone-in BBQ ~1 lb/person; cookouts spread protein across several meats so each meat type is portioned down.' } },
    { id: 'p_chicken', item: 'Chicken (legs/thighs/quarters)', category: 'food', qtyPerGuest: 0.45, unit: 'lb', where: ['Grocery', 'Costco', 'Butcher'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', note: 'Barbecued/grilled chicken is a cookout staple — dark meat holds up on the grill.' },
    { id: 'p_burgers_dogs', item: 'Burgers, hot dogs + links (sausage)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Costco'], unitCostRange: [3, 6], essential: true, buyAt: 'T-1d', note: 'Burgers, dogs, and links round out the grill and feed the kids and the early plates.' },
    { id: 'p_buns', item: 'Burger + hot dog buns / bread', category: 'food', qtyPerGuest: 2.5, unit: 'buns', where: ['Grocery', 'Bakery'], unitCostRange: [0.3, 0.6], essential: true, buyAt: 'T-1d' },
    { id: 'p_mac', item: 'Baked mac & cheese ingredients (or pans)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery'], unitCostRange: [2, 4], essential: true, buyAt: 'T-2d', note: 'Baked, not stovetop — this is a flagship side, not a filler.' },
    { id: 'p_potato_salad', item: 'Potato salad ingredients', category: 'food', qtyPerGuest: 0.35, unit: 'lb', where: ['Grocery'], unitCostRange: [1.5, 3], essential: true, buyAt: 'T-2d', note: 'Claimed by the trusted hands — assign it to the one person whose potato salad everybody actually eats.' },
    { id: 'p_beans', item: 'Baked beans ingredients', category: 'food', qtyPerGuest: 0.3, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 2.5], essential: true, buyAt: 'T-2d' },
    { id: 'p_greens', item: 'Collard greens (+ smoked turkey/ham hock)', category: 'food', qtyPerGuest: 0.3, unit: 'lb', where: ['Grocery'], unitCostRange: [1.5, 3.5], essential: true, buyAt: 'T-2d', note: 'Slow-cooked greens — start them early. Pork or smoked turkey per the family.' },
    { id: 'p_cornbread', item: 'Cornbread', category: 'food', qtyPerGuest: 1, unit: 'piece', where: ['Grocery', 'Bakery'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-1d' },
    { id: 'p_slaw', item: 'Coleslaw ingredients', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 2], essential: false, buyAt: 'T-2d' },
    { id: 'p_dessert', item: 'Desserts (banana pudding, pound cake, peach cobbler, red velvet)', category: 'food', qtyPerGuest: 1.5, unit: 'serving', where: ['Grocery', 'Bakery', 'Homemade'], unitCostRange: [1.5, 4], essential: true, buyAt: 'T-1d', note: 'Banana pudding is practically mandatory; plan more than one dessert — people take dessert to go too.' },
    { id: 'p_condiments', item: 'Condiments, BBQ sauce, hot sauce, cheese, lettuce, onion, pickles', category: 'food', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [25, 50], essential: true, buyAt: 'T-3d' },
  ...
  risks: [
    ...
    { id: 'r_foodsafe', trigger: 'Perishable sides sit out in the heat too long', severity: 'high', mitigation: 'Keep cold sides on ice; don\'t leave mayo-based dishes (potato salad, slaw) out >1h above 90°F; grill meat to safe temps (chicken 165°F).' },
