...
const theCookout = {
  ...
  purchases: [
    ...
    { id: 'p_cleanup', item: 'Trash + recycling bags, gloves, sanitizing wipes', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Costco'], unitCostRange: [12, 25], essential: true, buyAt: 'T-3d', note: 'A real all-day cookout makes real trash — extra heavy-duty bags + a recycling bag for cans/bottles.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
