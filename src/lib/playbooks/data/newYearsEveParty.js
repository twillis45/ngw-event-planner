...
// Toast math (one 750ml bottle pours about six flutes; plan a bottle per
// five guests so the toast pour is generous and seconds exist) is a
// synthesized US bar-stocking heuristic. No fabricated sources, no
// fabricated costProvenance. ESM default export.
...
const newYearsEveParty = {
  ...
  decisions: [
    ...
    },
    {
      ...
      costFactorProvenance: { tier: 'synthesized', confidence: 'low', verificationStatus: 'synthesized', note: 'Ratios judged from retail: sparkling cider runs a third to half the price of drinkable sparkling wine per bottle; the all-sparkling-wine option adds the bottles the zero-proof share would have replaced.', claim: 'An all-wine toast costs about 20% more than the split; an all-zero-proof toast about halves the toast line', sufficientWhen: 'Shelf prices for one drinkable sparkling wine and one sparkling cider at the same store confirm the ratio' },
      ...
      why: 'Everyone toasts — which means the zero-proof option is not a garnish, it is a third of the glasses at many parties: designated drivers, pregnant guests, people who quit, kids at a family countdown. A real sparkling cider or zero-proof sparkler in the same flute means every raised glass looks the same. Pour math: a bottle fills about six flutes, so a bottle per five guests covers a generous toast and the refill wave that follows it.',
    },
    {
      id: 'staying_late',
