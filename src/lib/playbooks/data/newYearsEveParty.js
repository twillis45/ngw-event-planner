...
const newYearsEveParty = {
  ...
  decisions: [
    ...
    },
    {
      ...
      defaultWhy: 'A live broadcast is the default because it cannot buffer into the new year the way a stream can. Change it if you would rather run a stream or your own clock — then test it on the actual screen and the actual wifi, and pick the backup before the night.',
      when: 'T-7d',
    ...
    },
    {
      ...
      defaultWhy: 'Sparkling wine plus a real zero-proof sparkler is the default because everyone toasts, and the designated drivers, the pregnant guests and the people who quit should be raising the same flute as everyone else. Change it if you know every glass in the room and can pour one way for all of them.',
      when: 'T-7d',
      blocks: ['beverage'],
