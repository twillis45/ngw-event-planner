...
const engagementParty = {
  ...
  purchases: [
    ...
    { id: 'p_champagne', item: 'Champagne / sparkling wine for the toast', category: 'beverage', qtyFlat: 1, qtyPer: 7, unit: 'bottle per ~7 guests', where: ['Wine shop', 'Total Wine', 'Costco'], unitCostRange: [12, 30], essential: true, buyAt: 'T-3d', note: 'Toast pour is a half-glass, so ~1 bottle per 6-8 guests covers everyone. Buy a couple extra for the bar.', provenance: { tier: 'heuristic', confidence: 'low', verificationStatus: 'synthesized', sources: [], note: 'Champagne-toast heuristic: a 750ml bottle pours ~7-10 toast portions (half-glass each); plan ~1 bottle per 6-8 guests.' } },
    ...
    { id: 'p_guestbook', item: 'Guest book / sign-in (book, advice cards, or a signable print) + pens', category: 'decor', qtyFlat: 1, unit: 'set', where: ['Etsy', 'Amazon', 'Bookstore'], unitCostRange: [15, 40], essential: true, buyAt: 'T-3d', note: 'A keepsake the couple actually wants — advice/well-wishes cards beat a blank book for getting people to write.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
