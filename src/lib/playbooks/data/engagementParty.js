...
const engagementParty = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host makes heavy apps', 'Caterer / passed apps', 'Potluck spread', 'Restaurant / private room'], default: 'Host makes heavy apps', when: 'T-21d', blocks: ['food', 'vendors'], costFactors: { 'Caterer / passed apps': 1.4, 'Potluck spread': 0.6, 'Restaurant / private room': 1.5 }, affects: ['p_apps_hot', 'p_apps_cold', 'p_grazing'], why: 'For a party format the apps must be a real meal — a caterer or restaurant is the call if the host wants to be a guest at their own engagement.' },
