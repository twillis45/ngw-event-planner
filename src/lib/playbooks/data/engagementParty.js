...
const engagementParty = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host makes heavy apps', 'Caterer / passed apps', 'Potluck spread', 'Restaurant / private room'], default: 'Host makes heavy apps', when: 'T-21d', blocks: ['food', 'vendors'], why: 'For a party format the apps must be a real meal — a caterer or restaurant is the call if the host wants to be a guest at their own engagement.' },
