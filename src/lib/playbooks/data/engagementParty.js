...
const engagementParty = {
  ...
  purchases: [
    { id: 'p_apps_hot', item: 'Hot passed appetizers (meatballs, sliders, bacon-wrapped, spanakopita)', category: 'food', qtyPerGuest: 5, unit: 'bites', where: ['Grocery', 'Costco', 'Caterer', 'Trader Joe\'s'], unitCostRange: [0.6, 1.5], essential: true, buyAt: 'T-3d', note: '~half of the ~10-12 bites/guest target. Freezer apps are a legitimate shortcut at 30+ guests.', provenance: 'Cocktail-party heuristic: ~8-12 hors d\'oeuvre bites/guest over a 2-3h evening event (no seated meal).' },
    { id: 'p_apps_cold', item: 'Cold passed appetizers (crostini, deviled eggs, shrimp, caprese skewers)', category: 'food', qtyPerGuest: 4, unit: 'bites', where: ['Grocery', 'Caterer'], unitCostRange: [0.6, 1.8], essential: true, buyAt: 'T-1d', provenance: 'Other half of the ~10-12 bites/guest cocktail-party target; cold bites are make-ahead friendly.' },
    { id: 'p_grazing', item: 'Cheese + charcuterie + crackers grazing station', category: 'food', qtyPerGuest: 0.2, unit: 'lb', where: ['Grocery', 'Cheese shop', 'Costco'], unitCostRange: [4, 9], essential: true, buyAt: 'T-1d', note: 'A self-serve anchor station takes pressure off passed apps and looks abundant.' },
    { id: 'p_dessert', item: 'Sweet bites / dessert table (mini desserts, fruit, cake pops)', category: 'food', qtyPerGuest: 2, unit: 'bites', where: ['Bakery', 'Grocery'], unitCostRange: [0.8, 2.5], essential: false, buyAt: 'T-1d', note: 'Optional but expected at an engagement party — even a simple "Cheers to the couple" cake.' },
