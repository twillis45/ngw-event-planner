...
const engagementParty = {
  ...
  decisions: [
    ...
    { id: 'toast', label: 'Who toasts, and in what order?', options: ['Host/parent opens → couple closes', 'Best friend / sibling toast', 'Open-mic (1-2 short)', 'Couple-only thank-you'], default: 'Host opens → couple closes', when: 'T-10d', blocks: ['runofshow'], weight: 'high', reversibility: 'costly', emotionalWeight: 'high', difmCapable: 'needs-host', deliversHeartMoment: true, priorityBasis: { rationale: 'This is the toast the couple remembers — the hero beat of the night; protect it above the logistics of passing apps and pouring drinks.', tier: 'reasoned' }, why: 'The toast is the hero beat. Pre-assigning 1-2 speakers (not an open mic free-for-all) keeps it to ~5 minutes, on-message, and dry-eye-optional.' },
    { id: 'invite', label: 'Invite + RSVP + dietary/allergy ask', options: ['Paper invite', 'Digital (Paperless Post / Evite)', 'Group text', 'Phone + text combo'], default: 'Digital (Paperless Post / Evite)', when: 'T-30d', blocks: ['headcount'], weight: 'high', reversibility: 'costly', emotionalWeight: 'low', difmCapable: 'needs-host', priorityBasis: { rationale: 'Headcount is the master variable every quantity scales off, and it collects allergies before the menu locks — the host has to send it.', tier: 'reasoned' }, why: 'Headcount is the master variable — every food, drink, and rental quantity scales off it. Collect allergies here, before the menu locks.' },
    { id: 'help', standsDownWhen: { id: 'venue', in: ['Restaurant private room', 'Event venue / bar buyout'] }, label: 'DIY, or bring in help?', options: ['Fully DIY', 'Hire a bartender', 'Drop-off / passed-app catering', 'Bartender + cleaner', 'Day-of helper for refills'], default: 'Hire a bartender', when: 'T-20d', blocks: ['vendors'], weight: 'med', reversibility: 'costly', emotionalWeight: 'low', difmCapable: 'can-derive', priorityBasis: { rationale: 'One host cannot pass apps, tend bar, and be present for the toast — a real staffing call the app can default to hiring a bartender.', tier: 'reasoned' }, why: 'For 30-40 guests one host cannot pass apps, tend bar, AND host. A bartender (~$200) or a teen to clear and refill is what lets the couple\'s family actually be present for the toast.' },
  ],
  ...
  purchases: [
    { id: 'p_apps_hot', item: 'Meatballs & sliders (bacon-wrapped, spanakopita)', category: 'food', qtyPerGuest: 5, unit: 'bites', where: ['Grocery', 'Costco', 'Caterer', 'Trader Joe\'s'], unitCostRange: [0.6, 1.5], essential: true, buyAt: 'T-3d', note: '~half of the ~10-12 bites/guest target. Freezer apps are a legitimate shortcut at 30+ guests.', provenance: { tier: 'heuristic', confidence: 'low', verificationStatus: 'synthesized', sources: [], note: 'Cocktail-party heuristic: ~8-12 hors d\'oeuvre bites/guest over a 2-3h evening event (no seated meal).' } , alternatives: ['Frozen Trader Joes or Costco apps — cheaper, bake day-of', 'Grocery deli meatball tray — budget hot protein option'] },
    { id: 'p_apps_cold', item: 'Crostini & deviled eggs (shrimp, caprese skewers)', category: 'food', qtyPerGuest: 4, unit: 'bites', where: ['Grocery', 'Caterer'], unitCostRange: [0.6, 1.8], essential: true, buyAt: 'T-1d', provenance: { tier: 'heuristic', confidence: 'low', verificationStatus: 'synthesized', sources: [], note: 'Other half of the ~10-12 bites/guest cocktail-party target; cold bites are make-ahead friendly.' } , alternatives: ['Costco charcuterie kit — pre-assembled, cheaper per lb', 'Grocery deli platter — budget cold app option'] },
    { id: 'p_grazing', item: 'Cheese + charcuterie + crackers grazing station', category: 'food', qtyPerGuest: 0.2, unit: 'lb', where: ['Grocery', 'Cheese shop', 'Costco'], unitCostRange: [4, 20], essential: true, buyAt: 'T-1d', note: 'A self-serve anchor station takes pressure off passed apps and looks abundant.' , alternatives: ['Store-brand crackers with one good cheese — cheaper by half', 'Hummus plus pita plus olives — budget Mediterranean grazing option'] , costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['charcuterie-ica-2026', 'charcuterie-grocery-2026'], lastVerified: '2026-08-15', claim: 'A cheese, charcuterie and cracker grazing station runs $4-20/lb: crackers and fresh fruit sit at $1-5/lb, budget cheese at $5-15, and the crowd-pleaser cheeses and cured meats that carry the board at $10-25. US grocery averages are ~$15/lb specialty cheese and ~$20/lb charcuterie meats.', sufficientWhen: 'Re-checked against per-pound cheese and cured-meat pricing. A ready-made board from the cheese shop this item lists is priced per board rather than per pound ($85 small to $285 extra-large), so that channel is out of band by construction.' } },
    { id: 'p_dessert', item: 'Mini desserts & cake pops (fruit, sweet bites)', category: 'food', qtyPerGuest: 2, unit: 'bites', where: ['Bakery', 'Grocery'], unitCostRange: [0.8, 2.5], essential: false, buyAt: 'T-1d', note: 'Optional but expected at an engagement party — even a simple "Cheers to the couple" cake.' , alternatives: ['Grocery bakery cookies by the dozen — cheapest per serving', 'Cake pops from grocery bakery — easy to serve, no cutting needed'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_champagne', item: 'Champagne / sparkling wine for the toast', category: 'beverage', qtyFlat: 1, qtyPer: 7, unit: 'bottle per ~7 guests', where: ['Wine shop', 'Total Wine', 'Costco'], unitCostRange: [12, 35], essential: true, buyAt: 'T-3d', note: 'Toast pour is a half-glass, so ~1 bottle per 6-8 guests covers everyone. Buy a couple extra for the bar.', costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', note: 'Champagne-toast heuristic: a 750ml bottle pours ~7-10 toast portions (half-glass each); plan ~1 bottle per 6-8 guests.', sources: ['costhelper-champagne-2026', 'sparklingwine-band-2026'], lastVerified: '2026-08-15', claim: 'A toast bottle runs $12-35: Spanish cava lands ~$14, sparkling wine averages $15-25, and true Champagne starts at $30-40 before rising steeply.', sufficientWhen: 'Re-checked against retail sparkling and Champagne pricing. The quantity heuristic in `note` is a SEPARATE claim from this price and was preserved rather than overwritten. Excludes corkage, charged separately at $1+ per bottle.' } },
    { id: 'p_wine', item: 'Still wine (white/rosé heavy, some red)', category: 'beverage', qtyPerGuest: 0.4, unit: 'bottle', where: ['Wine shop', 'Total Wine', 'Grocery'], unitCostRange: [8, 25], essential: true, buyAt: 'T-3d', note: 'Wine + beer carry most of the ~1 drink/guest/hour load; lean lighter/chilled for a cocktail party.' , costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['wine-retail-2026', 'wine-statewide-2026'], lastVerified: '2026-08-15', claim: 'A retail bottle runs $8-25: the everyday grocery shelf is $8-15, mid-range wine-shop bottles $15-30, and state averages cluster near $14 (from $10.97 in Massachusetts to $15.51 in Mississippi).', sufficientWhen: 'Re-checked against retail tier bands and state averages. Premium bottles at $30-100+ sit above this line and restaurant pricing is a different market entirely. NOTE the widely-quoted $56.78 US average is DIRECT-TO-CONSUMER data covering 10-11% of off-premise volume - it is not a shelf price and must not be used to set this band.' } },
    { id: 'p_beer', item: 'Beer + hard seltzer (cans/bottles, on ice)', category: 'beverage', qtyPerGuest: 1.5, unit: 'cans', where: ['Grocery', 'Costco', 'Liquor store'], unitCostRange: [1.2, 2.5], essential: true, buyAt: 'T-3d', provenance: { tier: 'heuristic', confidence: 'low', verificationStatus: 'synthesized', sources: [], note: 'Plan ~1 drink/guest/hour; beer/seltzer is the easy self-serve share of the mix.' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['seltzer-retail-2026', 'beer-retail-2026', 'beer-budget-2026'], lastVerified: '2026-08-16', claim: 'This band is a SUM of separately-priced drink families, not a single quoted item: hard seltzer about $1.33-1.60 a can ($15.99-22.99 a 12-pack); domestic lager $0.80-1.20 per 12oz (about $20-22 a 24-pack), craft $1.50-3.00. Each component is cited to its own registered source; the summed band is therefore low-confidence by construction.', sufficientWhen: 'Current shelf prices for one pack of each named component at the same store, summed to the per-serving band, confirm the range.' } },
