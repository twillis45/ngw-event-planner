...
const gameNight = {
  ...
  decisions: [
    ...
    { id: 'food_model', label: 'Who provides the food?', options: ['Host provides snacks', 'Potluck (guests bring a dish)'], default: 'Host provides snacks', when: 'T-7d', blocks: ['food'], costFactors: { 'Potluck (guests bring a dish)': 0.5 }, affects: ['p_snacks', 'p_dips', 'p_board'], why: 'Host-provided is simple and predictable but costs more; potluck cuts host cost/effort but needs a quick coordination note so you do not end up with five bags of chips and no dip.' },
