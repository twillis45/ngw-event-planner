...
const gameNight = {
  ...
  purchases: [
    { id: 'p_snacks', item: 'Chips, crackers, pretzels & popcorn (low-mess dry snacks)', category: 'food', qtyPerGuest: 1, unit: 'snack serving', where: ['Grocery', 'Costco'], unitCostRange: [1, 2.5], essential: true, buyAt: 'T-1d', note: 'Dry, one-hand snacks keep fingers clean for cards. ~6-8 finger-food bites/guest/hour across all snacks when grazing is the meal.', alternatives: ['Store-brand chips + pretzels — same function at half the cost', 'Microwave popcorn (bulk box) — cheapest snack filler option'], provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~6-8 appetizer bites/person/hour when food is grazing-only.', claim: '~6–8 dry finger-food bites per person per hour is sufficient when grazing snacks are the entire food offering', sufficientWhen: 'verified — board consensus confirmed this baseline for a focused game night; established-consensus for grazing-only party food' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['snacks-format-2026', 'chips-bls-2026'], lastVerified: '2026-08-18', claim: 'Dry snacks per serving, and FORMAT decides where in the band a table lands. From a 13oz party bag chips are $0.38-0.40 an ounce, so a two-ounce serving is about $0.80; pretzels are cheaper at $0.25-0.27 an ounce and popcorn dearer at $0.51-0.75 because the bag is light for its volume. A single-serve bag is $1.12 an ounce - 2.8x the party bag - which is what carries a serving to this band\'s ceiling.', sufficientWhen: 'A party-size bag and a single-serve bag of the same chip, divided per serving, confirm both ends.' }, },
    { id: 'p_dips', item: 'Dips (hummus, guac, queso, ranch) — at the station, not the table', category: 'food', qtyPerGuest: 0.7, unit: 'small serving', where: ['Grocery'], unitCostRange: [0.4, 0.75], essential: true, buyAt: 'T-1d', note: 'Shallow bowls at the snack station, off the game surface.', alternatives: ['Store-brand sour cream dip — cheapest option', 'Canned queso (Tostitos) — no prep, budget alternative to fresh queso'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['dips-snackstation-2026', 'dips-retail-2026'], lastVerified: '2026-08-18', claim: 'Hummus, queso, and guac tubs run $0.50-0.65 per 2oz serving across two independent retailers (Walmart/Costco, and separately H-E-B/Walmart). Ranch and salsa excluded — see p_salsa for the uncited remainder. Row split and band lowered 2026-08-18 (was combined at $1-2/serving).', sufficientWhen: 'A second source confirming ranch pricing would let it rejoin this row.' } },
    { id: 'p_salsa', item: 'Salsa', category: 'food', qtyPerGuest: 0.3, unit: 'small serving', where: ['Grocery'], unitCostRange: [0.25, 0.4], essential: false, buyAt: 'T-1d', note: 'At the snack station alongside the other dips.', provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['salsa-costco-2026', 'salsa-walmart-2026'], lastVerified: '2026-08-18', claim: 'Jarred salsa, two independent retailers converge tightly at $0.12-0.13/oz (Costco 2-pack, Walmart single jar), i.e. ~$0.25-0.40 per 2-3oz serving. Cited 2026-08-18.', sufficientWhen: 'Confirmed — two independent retailers converge tightly.' } },
    ...
    { id: 'p_napkins', item: 'Cocktail napkins + hand wipes (keep within reach of the table)', category: 'logistics', qtyPerGuest: 6, unit: 'napkin', where: ['Grocery'], unitCostRange: [0.03, 0.08], essential: true, buyAt: 'T-1d', note: 'COMMONLY FORGOTTEN: greasy fingers on cards/components is the #1 game-night regret — stock plenty of napkins AND a tub of hand wipes on the table.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['disposables-partyqty-2026', 'costco-cleaning-2026'], lastVerified: '2026-08-18', claim: 'Cocktail napkins per napkin. Bulk party-supply pricing puts basic paper plates near 6 cents each with napkins bought in the same order, so a cocktail napkin sits in the low single cents; hand wipes are $4.27 an 85-count canister, about 5 cents each. Both land inside this band.', sufficientWhen: 'A bulk napkin pack price and a wipe canister, divided per unit, confirm the band.' }, },
    ...
    { id: 'p_scorepad', item: 'Scorepad + pens (and a new filler game, optional)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Home', 'Game store', 'Big-box'], unitCostRange: [3, 30], essential: false, buyAt: 'T-3d', note: 'Pen + scratch paper for scoring; optional new crowd-friendly game bought early enough to read the rules first.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['meetingsupplies-quill-2026', 'meetingsupplies-target-2026', 'games-retail-2026'], lastVerified: '2026-08-18', claim: 'Scoring supplies with an optional game. PENS are $0.10-0.19 each in bulk and paper pads $0.56-1.17 each, which is the floor - a scorepad and pens is a couple of dollars. THE OPTIONAL FILLER GAME is what carries the band to its ceiling: travel and filler titles are $7.69-9.99 and full party games $19.99-24.99. Dedicated scorepads could not be priced at two publishers, so the paper line rests on general pad pricing.', sufficientWhen: 'A scorepad price from two publishers, plus one filler-game price, confirm both ends.' }, },
