...
const gameNight = {
  ...
  purchases: [
    ...
    { id: 'p_board', item: 'Charcuterie / pre-cut finger foods (cheese, cured meats, olives, veggie cups)', category: 'food', qtyPerGuest: 1, unit: 'portion', where: ['Grocery', 'Costco'], unitCostRange: [3, 6], essential: false, buyAt: 'T-1d', note: 'Pre-cut so no plates/knives at the table; makes the spread feel intentional.', alternatives: ['Store-brand crackers + one block cheese sliced — cheaper by half', 'Grocery charcuterie pack — pre-assembled, less expensive'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_trash', item: 'Trash + recycling bags, paper towels', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [3, 7], essential: true, buyAt: 'T-1d', note: 'COMMONLY FORGOTTEN: have 2-3 ready so you can swap a full bag mid-night.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
