...
const gameNight = {
  ...
  purchases: [
    ...
    { id: 'p_salsa', item: 'Salsa', category: 'food', qtyPerGuest: 0.3, unit: 'small serving', where: ['Grocery'], unitCostRange: [0.3, 0.75], essential: false, buyAt: 'T-1d', note: 'Split out 2026-08-18 — no corroborated pricing found yet; band is an unverified estimate.', provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
