...
const watchParty = {
  ...
  purchases: [
    { id: 'p_wings', item: 'Chicken wings', category: 'food', qtyPerGuest: 1, unit: 'lb', where: ['Grocery', 'Costco', 'Butcher'], unitCostRange: [3, 6], essential: true, buyAt: 'T-1d', note: 'Game day runs big — plan ~1 lb (about 8–12 pieces) per guest; wings sell out the day before a big game.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: 'Super Bowl heuristic ~10–12 wings/guest (≈1 lb) for an all-afternoon graze.' } },
    { id: 'p_chips', item: 'Chips + dips (queso, guac, salsa, French onion)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Grocery', 'Costco'], unitCostRange: [1.5, 3], essential: true, buyAt: 'T-3d', note: 'Chips keep; buy refrigerated dips fresh at T-1d.' },
    { id: 'p_chili', item: 'Chili (meat, beans, tomatoes, toppings)', category: 'food', qtyPerGuest: 0.5, unit: 'serving', where: ['Grocery'], unitCostRange: [2, 4], essential: false, buyAt: 'T-1d', note: 'Make-ahead crowd-pleaser; ~1 cup per guest, better the next day.' },
    { id: 'p_pizza_sliders', item: 'Pizza / sliders (handheld mains)', category: 'food', qtyPerGuest: 2, unit: 'slices', where: ['Grocery', 'Pizza shop', 'Costco'], unitCostRange: [1.5, 3], essential: true, buyAt: 'T0', note: 'Roughly 2–3 large pizzas per 10 guests; order delivery for kickoff if not baking.' },
    { id: 'p_dessert', item: 'Dessert (brownies, cookies, snack mix)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Grocery', 'Bakery'], unitCostRange: [1, 3], essential: false, buyAt: 'T-1d' },
