...
const watchParty = {
  ...
  purchases: [
    ...
    { id: 'p_pizza_sliders', item: 'Pizza / sliders (handheld mains)', category: 'food', qtyPerGuest: 2, unit: 'slices', where: ['Grocery', 'Pizza shop', 'Costco'], unitCostRange: [1.5, 3], essential: true, buyAt: 'T0', note: 'Roughly 2–3 large pizzas per 10 guests; order delivery for kickoff if not baking.', alternatives: ['Frozen pizza (Costco/DiGiorno) — cheaper than delivery', 'Slider rolls + deli meat — budget handheld option'] },
    { id: 'p_dessert', item: 'Dessert (brownies, cookies, snack mix)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Grocery', 'Bakery'], unitCostRange: [1, 3], essential: false, buyAt: 'T-1d', alternatives: ['Store-brand cookies — cheapest dessert option', 'Brownies from box mix — budget bake, tastes homemade'] },
