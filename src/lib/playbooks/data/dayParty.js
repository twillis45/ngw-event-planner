...
const dayParty = {
  ...
  purchases: [
    ...
    { id: 'p_speakers', item: 'Speaker / PA rental (if no DJ or DJ does not bring sound)', category: 'logistics', qtyFlat: 1, unit: 'system', where: ['AV rental', 'Music store', 'Amazon'], unitCostRange: [80, 250], essential: false, buyAt: 'T-3d', note: 'If you went the playlist route, real speakers are non-negotiable — never a phone on a Bluetooth puck. Confirm power/outlets outside.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
