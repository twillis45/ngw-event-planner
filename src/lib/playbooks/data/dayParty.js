...
const dayParty = {
  ...
  purchases: [
    ...
    { id: 'p_mixers', item: 'Mixers (club soda, tonic, ginger beer, citrus)', category: 'beverage', qtyPerGuest: 1, unit: 'serving', where: ['Grocery', 'Costco'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
