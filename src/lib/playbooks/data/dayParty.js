...
const dayParty = {
  ...
  purchases: [
    ...
    { id: 'p_cups', item: 'Cups, plates, napkins, cocktail picks, cutlery (disposable)', category: 'rental', qtyPerGuest: 3, unit: 'set', where: ['Party store', 'Costco', 'Grocery'], unitCostRange: [0.2, 0.7], essential: true, buyAt: 'T-3d', note: 'Day parties go through cups — people set one down and grab a fresh one. Buy 3x.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
