...
const dayParty = {
  ...
  purchases: [
    ...
    { id: 'p_bites', item: 'Charcuterie, wings & sliders (skewers, fruit)', category: 'food', qtyPerGuest: 5, unit: 'pieces', where: ['Grocery', 'Costco', 'Caterer'], unitCostRange: [1, 3], essential: true, buyAt: 'T-1d', note: 'Hand-held, all-afternoon food. ~5-6 bites/guest for a no-meal day party; a grazing table holds the room without table service. In the DMV, mambo/mumbo-sauce wings are the recognized bite.', alternatives: ['Costco party platters — cheaper per bite, minimal prep', 'Frozen appetizers (Trader Joe\'s) — budget option, bake day-of', 'Fruit + veggie tray + dip — cheapest grazing option if budget is tight'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
