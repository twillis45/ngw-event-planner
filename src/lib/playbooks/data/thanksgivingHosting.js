...
//   • Thaw start at five days: judged from the standard fridge-thaw rate of
//     roughly 24 hours per 4-5 lb (USDA-style guidance, widely published) for
//     a 12-16 lb bird plus a day of margin. A judgment, not a citation.
...
const thanksgivingHosting = {
  ...
  purchases: [
    ...
    { id: 'p_wine_cider', item: 'Wine + sparkling cider (a bottle each of red and white per table end, cider for kids and non-drinkers)', category: 'beverage', qtyFlat: 1, qtyPer: 4, unit: 'bottle per 4 guests', where: ['Wine shop', 'Grocery'], unitCostRange: [7, 20], essential: true, buyAt: 'T-3d', note: 'A long afternoon meal, not a party — plan lighter than a cocktail event, and make the zero-proof option a real one on the table, not a concession in the fridge.', provenance: { tier: 'heuristic', confidence: 'low', verificationStatus: 'synthesized', sources: [], note: 'One bottle per four guests reflects the roughly one-drink-per-guest-per-hour norm applied to a meal-centered afternoon with many non-drinkers and drivers.' } },
