...
const thanksgivingHosting = {
  ...
  decisions: [
    ...
    },
    {
      ...
      defaultWhy: 'Roasting is the default because it needs no equipment you do not already own and no open flame outside the house. Change it if you have a fryer or a smoker and want the oven back for the sides — a roasted bird owns it for three to four hours, which is exactly when the sides want it.',
      when: 'T-14d',
    ...
    },
    {
      ...
      defaultWhy: 'Late afternoon is the default because it gives a morning cook runway on one oven and leaves out-of-town family time to arrive before the table is set. Change it to early afternoon if your guests are driving home the same night.',
      when: 'T-14d',
