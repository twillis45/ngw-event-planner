  ...
  decisions: [
    {
      ...
      when: 'T-42d',
      timingProvenance: { tier: 'researched', verificationStatus: 'researched', sources: ['partychecklist-timeline-2026'], claim: 'Party-planning guides put the planning start at 4-8 weeks out, and the source names eight weeks as the end that wins for a date-competitive holiday weekend. The shipped six-week start sits in the MIDDLE of that window, not at its conservative end — inside what the source supports, and two weeks short of what the source recommends for exactly this kind of date.', rationale: 'CORRECTED 2026-09-19. This record previously claimed the six-week start "sits in that window at its conservative end". It does not: the registered source (timingProvenance.js#partychecklist-timeline-2026) reads "start the planning timeline at least 8 weeks out", calls 4 to 8 weeks the sweet spot, and says popular dates book earliest "so the conservative end of the window wins for a date-competitive holiday weekend". Six weeks is the middle of four to eight, and late October is precisely the competitive case the source singles out. THE DEADLINE WAS NOT MOVED — whether to ship eight weeks is a product call on a commercially-interested source, and the house rule (timingProvenance.js:314) is that such a source does not move a host-facing date by itself. What was wrong either way was this claim describing the source, so only the description changed.' },
    ...
    },
    {
      ...
      defaultWhy: 'Judged categories are the default because spreading the wins — scariest, funniest, best duo, best kid, best effort — stops one elaborate costume from taking everything. Change it to an applause vote if you would rather not name judges, or drop the contest if your crowd wears costumes for their own sake.',
      when: 'T-21d',
    ...
    },
    {
      ...
      defaultWhy: 'A party spread plus the candy table is the default because a party crossing dinner hours needs real savory food under the sugar. Change it to treats-only if yours is a short evening party, or to a potluck if the crowd is family and everyone brings a dish.',
      when: 'T-14d',
      blocks: ['food'],
    ...
    },
    {
      ...
      defaultWhy: 'Beer and wine only is the default because this is the one night your guests drive home through streets full of kids on foot, and a simple bar is the one you can keep an eye on. Change it to add a themed batch cocktail if the party is adults-only, or to zero-proof if the kids are the point of the night.',
      when: 'T-14d',
      blocks: ['beverage'],
