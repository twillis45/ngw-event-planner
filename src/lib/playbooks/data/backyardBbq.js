...
const backyardBbq = {
  ...
  purchases: [
    ...
    { id: 'p_sides', item: 'Salads, beans, corn & chips', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery'], unitCostRange: [2, 4], essential: true, buyAt: 'T-1d', alternatives: ['Canned baked beans — near-zero prep, same crowd appeal', 'Bag of chips + store-bought dip — if time is short'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['pantry-canned-2026', 'snacks-format-2026', 'bls-saladveg-2026', 'corn-retail-2026'], lastVerified: '2026-08-18', claim: 'A mixed sides plate per pound. BEANS are cheap: dried $1.689/lb per BLS and canned $1.02-1.85/lb of contents. CANNED CORN $0.93-1.28/lb, fresh ears $0.50-1.25 each. SALADS price with the produce sources at $2.55-3.78/lb. CHIPS are the dearest component at $6.14-6.39/lb from a party bag. A plate leaning on beans and corn sits at this band\'s floor and a chip-heavy one at its ceiling.', sufficientWhen: 'Per-pound prices for beans, corn, salad and chips at the ratio actually served confirm the band.' }, },
