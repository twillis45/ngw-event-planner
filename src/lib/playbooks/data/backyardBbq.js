...
const backyardBbq = {
  ...
  purchases: [
    ...
    { id: 'p_drinks', item: 'Beer, soda & water', category: 'beverage', qtyPerGuest: 3, unit: 'drinks', where: ['Grocery', 'Costco', 'Liquor store'], unitCostRange: [1, 3], essential: true, buyAt: 'T-3d', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~3 drinks/guest over a 4h outdoor afternoon.' } },
