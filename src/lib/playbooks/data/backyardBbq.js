...
const backyardBbq = {
  ...
  purchases: [
    ...
    { id: 'p_sides', item: 'Salads, beans, corn & chips', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery'], unitCostRange: [2, 4], essential: true, buyAt: 'T-1d', alternatives: ['Canned baked beans — near-zero prep, same crowd appeal', 'Bag of chips + store-bought dip — if time is short'] },
