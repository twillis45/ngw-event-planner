...
const surpriseProposal = {
  ...
  decisions: [
    { id: 'public_private', label: 'Public moment or private/intimate?', options: ['Private (just the two of you)', 'Public with a hidden audience', 'Family + friends gathered after', 'Destination / trip proposal'], default: 'Private (just the two of you)', when: 'T-40d', blocks: ['location', 'permit', 'decor', 'celebration'], weight: 'high', reversibility: 'costly', emotionalWeight: 'high', difmCapable: 'needs-host', deliversHeartMoment: true, priorityBasis: { rationale: 'This is the shape of the moment itself — a public spectacle or just the two of you; it is the thing your partner remembers forever, so protect it above the logistics.', tier: 'reasoned' }, why: 'The single biggest fork. Public/destination drives permits, crowd control, travel, and a bigger circle of secret-keepers; private keeps it controllable and easier to keep secret.' },
    { id: 'who_knows', label: 'Who is in on it? (secret-keepers)', options: ['Nobody — solo', 'Photographer only', '2-3 trusted people', "Both families coordinated"], default: '2-3 trusted people', when: 'T-40d', blocks: ['celebration', 'ring'], weight: 'high', reversibility: 'costly', emotionalWeight: 'med', difmCapable: 'needs-host', priorityBasis: { rationale: 'Every extra person in on it is another way the surprise leaks — a call only the proposer can make, and one you cannot take back once someone knows.', tier: 'reasoned' }, why: 'Every extra person is another way the surprise leaks. Keep the circle as small as the plan allows; only loop in people who are doing a job (ring size, the cover story, the reveal).' },
    { id: 'photographer_hidden', label: 'Photographer hidden or known to your partner?', options: ['Hidden (true surprise)', 'Posing as a "free mini-shoot"', 'Known — partner expects photos'], default: 'Hidden (true surprise)', defaultWhy: 'Hidden is the default because the reaction you want in the photos only exists if your partner does not know the camera is there. Change it if your partner would not want to be photographed without knowing, or if you need a reason to get them dressed and to the right spot — the free mini-shoot cover exists for exactly that.', when: 'T-30d', blocks: ['photographer'], weight: 'med', reversibility: 'reversible', emotionalWeight: 'med', difmCapable: 'can-derive', priorityBasis: { rationale: 'Capturing the real reaction requires your partner not to know — hidden is the safe default for a true surprise, so the app can propose it.', tier: 'reasoned' }, why: 'Capturing the real reaction requires the partner not to know. A common cover is the photographer posing as a stranger or as a "free social-content mini-shoot" so the dressed-up, on-location setup feels natural.' },
    { id: 'ring_path', label: 'Ring: in-stock, custom, or family ring?', options: ['In-stock / quick', 'Custom (longer lead time)', 'Family heirloom (resize)', 'Propose first, ring later'], default: 'In-stock / quick', when: 'T-45d', blocks: ['ring'], weight: 'high', reversibility: 'costly', emotionalWeight: 'high', difmCapable: 'needs-host', priorityBasis: { rationale: 'The ring is deeply personal and sets the entire timeline — custom runs weeks and it is the one thing that can move the date, so the proposer must own it.', tier: 'reasoned' }, why: 'This sets the whole timeline. Custom rings commonly run 4-6 weeks; resizing an heirloom also takes time. The ring is the one thing that can blow the date if you start late.' },
    { id: 'celebration_style', ask: 'Dinner just the two of you, or family waiting nearby?', label: 'Celebration after the "yes"', options: ['Just the two of you (dinner reservation)', 'Surprise reveal with family/friends', 'Champagne toast on-site', 'Save the big party for later'], default: 'Surprise reveal with family/friends', when: 'T-21d', blocks: ['celebration'], weight: 'med', reversibility: 'reversible', emotionalWeight: 'med', difmCapable: 'needs-host', priorityBasis: { rationale: 'The moment is over in sixty seconds — planning who is there for the celebration after is a personal call that keeps the night from deflating.', tier: 'reasoned' }, why: 'The moment is over in 60 seconds — plan what happens next so the night does not deflate. A nearby dinner reservation or a family/friends reveal turns the moment into an evening.' },
  ],
  ...
  purchases: [
    { id: 'p_flowers', item: 'Flowers / bouquet', category: 'decor', qtyFlat: 1, unit: 'bouquet', where: ['Florist', 'Grocery', 'Trader Joe\'s'], unitCostRange: [20, 80], essential: false, buyAt: 'T-1d', note: 'Doubles as a prop and a cover ("just picked these up"). Fresh same-day.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['traderjoes-flowers-2026', 'paperlust-centerpieces-2026'], lastVerified: '2026-08-16', claim: 'Per bouquet 2026: supermarket bouquets run $3.99-19.99 (basic bunches $3.99-4.99, roses and tulips $6.99-9.99, specialty $8.99-12.99), and a supermarket rose bouquet is $12-20 against $40-100 for the same from a traditional florist. A separate florals guide puts DIY simple arrangements at $20-50 and florist standard at $75-150. A $20-80 bouquet spans a good supermarket bunch through a small florist arrangement.', sufficientWhen: 'A current supermarket bouquet price and one florist quote for a hand-tied bouquet confirm the band.' } },
    { id: 'p_candles', item: 'LED / battery candles + lanterns', category: 'decor', qtyFlat: 12, unit: 'candles', where: ['Amazon', 'Target', 'Party store'], unitCostRange: [1, 9], essential: false, buyAt: 'T-3d', note: 'Many parks/venues ban open flame — LED reads the same on camera and won\'t get the setup shut down.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['ledcandles-thermometer-2026', 'ledcandles-walmart-2026'], lastVerified: '2026-08-18', claim: 'Flameless LED candles span two real formats: tea-light multipacks $1.25-2/unit (Walmart), and pillar-style/moving-flame multipacks $3.75-8.66/unit (commodity tier, two publishers). Band widened 2026-08-18 to $1-9 to cover both — the middle of the range depends on which format is chosen. Lanterns are NOT priced in this citation.', sufficientWhen: 'A lantern price added closes the remaining gap in this bundled item name.' } },
    { id: 'p_sign', item: '"Marry Me" sign / marquee letters', category: 'decor', qtyFlat: 1, unit: 'sign', where: ['Etsy', 'Amazon', 'Party store'], unitCostRange: [15, 60], essential: false, buyAt: 'T-3d', note: 'A sign carries the moment without words and reads instantly in photos.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['marquee-letters-2026', 'signage-print-2026', 'banner-retail-2026'], lastVerified: '2026-08-18', claim: 'A proposal sign, and the band prices A SIGN rather than a letter set. A printed 18x24in foam board is $15-30 and a party-store banner $1.25. MARQUEE LETTERS ARE PRICED PER LETTER and blow past this band: $25.29 each to buy in foam or $59-60 each to rent, so a seven-character MARRY ME is about $177 to buy or $413-420 to rent. This row is grounded on the printed-sign option; choosing marquee letters is a different order of cost and the band does not cover it.', sufficientWhen: 'A printed-sign quote against a seven-letter marquee quote confirms which option this band prices.' }, },
    { id: 'p_petals', item: 'Real rose petals / faux-petal alternative', category: 'decor', qtyFlat: 1, unit: 'bag', where: ['Florist', 'Amazon'], unitCostRange: [8, 20], essential: false, buyAt: 'T-1d', note: 'CHECK THE RULES: many parks ban confetti/glitter/faux petals; some allow real petals only.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['rosepetals-garden-2026', 'rosepetals-flyboy-2026'], lastVerified: '2026-08-18', claim: 'Petals by the bag, and the band covers BOTH options this row names. REAL freeze-dried petals are $8.95 for a one-cup sample and $22.95 for 5 cups - the seller\'s own guide suggests half to one cup a guest, so a proposal-scale scatter is a few cups. FAUX silk petals are far cheaper per petal at $17.99-24.99 per 1,000. A small real bag or one faux value pack lands in this band; a wedding-scale 30-cup order at $86.95 is a different quantity entirely.', sufficientWhen: 'One small real-petal bag price and one 1,000-count faux pack confirm both options.' }, },
    { id: 'p_ringbox', item: 'Ring box (slim / pocket-friendly)', category: 'logistics', qtyFlat: 1, unit: 'box', where: ['Jeweler', 'Amazon'], unitCostRange: [10, 30], essential: true, buyAt: 'T-3d', note: 'COMMONLY OVERLOOKED: a bulky box prints through a pocket and tips off the surprise — a slim box hides better.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['proposal-items-2026', 'weddingstationery-2026'], lastVerified: '2026-08-18', claim: 'A slim pocket proposal box. Specialist sellers list super-slim models at $12.99, a discreet slim black at $15.99 and a slim pocket grey at $17.99 - all priced each, all inside this band. The point of the product is concealment, so the slim tier is the right one; a traditional hinged presentation box is a different item.', sufficientWhen: 'Two current slim-box prices confirm the band directly.' }, },
    { id: 'p_champagne', item: 'Champagne / sparkling + cups for the toast', category: 'beverage', qtyPerGuest: 1, unit: 'glass', where: ['Liquor store', 'Grocery'], unitCostRange: [3, 10], essential: false, buyAt: 'T-1d', note: 'The first toast after the yes. Scale to whoever is gathered after. No alcohol in many public parks — toast at the celebration instead.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['costhelper-champagne-2026', 'sparklingwine-band-2026', 'disposables-bulk-2026', 'disposables-partyqty-2026'], lastVerified: '2026-08-16', claim: 'A SUM of two families: sparkling wine $15-25 a bottle (budget near $5) plus disposable cups at roughly 6 cents each in bulk packs and $0.25-0.40 at a grocery store. Cited to both registries; the summed band is low-confidence by construction.', sufficientWhen: 'Current shelf prices for one sparkling bottle and one cup pack at the same store, summed, confirm the band.' } },
    { id: 'p_keepsake', item: 'Keepsake (note, vows, small gift)', category: 'decor', qtyFlat: 1, unit: 'item', where: ['Stationery', 'Home'], unitCostRange: [0, 30], essential: false, buyAt: 'T-3d', note: 'Optional — a handwritten note or first-night keepsake for the partner.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
