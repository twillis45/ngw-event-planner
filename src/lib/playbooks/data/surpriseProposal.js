...
const surpriseProposal = {
  ...
  purchases: [
    ...
    { id: 'p_candles', item: 'LED / battery candles + lanterns', category: 'decor', qtyFlat: 12, unit: 'candles', where: ['Amazon', 'Target', 'Party store'], unitCostRange: [1, 3], essential: false, buyAt: 'T-3d', note: 'Many parks/venues ban open flame — LED reads the same on camera and won\'t get the setup shut down.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
