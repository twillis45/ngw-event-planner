...
const teamRetreat = {
  ...
  purchases: [
    ...
    { id: 'p_drinks', item: 'Sparkling water, soda & mocktail mixers', category: 'beverage', qtyPerGuest: 3, unit: 'drinks', where: ['Grocery', 'Venue bar'], unitCostRange: [1, 5], essential: false, buyAt: 'T-1d', note: 'INCLUSION: not everyone drinks — always stock equal non-alcoholic options, never make alcohol the only social glue.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
