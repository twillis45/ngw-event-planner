...
const teamRetreat = {
  ...
  purchases: [
    { id: 'p_nametags', item: 'Name tags / lanyards', category: 'logistics', qtyPerGuest: 1, unit: 'badge', where: ['Office store', 'Amazon'], unitCostRange: [0.5, 2], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
