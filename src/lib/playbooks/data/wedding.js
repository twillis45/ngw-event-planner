...
const wedding = {
  ...
  purchases: [
    { id: 'p_favors', item: 'Guest favors', category: 'decor', qtyPerGuest: 1, unit: 'favor', where: ['Etsy', 'Party store', 'Specialty / local'], unitCostRange: [2, 8], essential: false, buyAt: 'T-3d', note: 'Order well ahead if custom; the 3 days out window is for pickup/assembly, not first purchase.' },
