...
const wedding = {
  ...
  purchases: [
    ...
    { id: 'p_welcomebags', item: 'Welcome bags (out-of-town guests)', category: 'logistics', qtyFlat: 1, qtyPer: 4, unit: 'bag', where: ['Amazon', 'Party store', 'Grocery'], unitCostRange: [8, 20], essential: false, buyAt: 'T-3d', note: 'One per hotel room for traveling guests — water, snacks, a map/itinerary card. Assemble the day before.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_emergencykit', item: 'Day-of emergency kit', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Pharmacy', 'Amazon', 'Grocery'], unitCostRange: [40, 80], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN. Sewing kit, safety pins, fashion tape, stain remover, pain reliever, bobby pins, hairspray, blotting papers, deodorant, breath mints, Band-Aids, phone charger, scissors, extra earring backs. Pack at rehearsal.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_signage', item: 'Signage (welcome sign, seating chart, directional)', category: 'decor', qtyFlat: 4, unit: 'sign', where: ['Etsy', 'Print shop', 'Sign maker'], unitCostRange: [25, 120], essential: false, buyAt: 'T-3d', note: 'Welcome sign, seating chart, bar/menu, and directional signs — proofread names against the FINAL list.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_guestbook', item: 'Guest book + pens', category: 'decor', qtyFlat: 1, unit: 'set', where: ['Etsy', 'Bookstore', 'Party store'], unitCostRange: [15, 50], essential: false, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_toast_champagne', item: 'Toast champagne / sparkling (if self-supplied)', category: 'beverage', qtyPerGuest: 0.14, unit: 'bottle', where: ['Liquor store', 'Costco', 'Warehouse'], unitCostRange: [12, 35], essential: false, buyAt: 'T-3d', note: '~1 bottle per 6–8 guests for a half-glass toast. Many full-service venues/caterers supply this — only buy if your bar is self-supplied.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
