...
const ptaBoosterFundraiser = {
  ...
  decisions: [
    ...
    },
    {
      ...
      defaultWhy: 'Presale plus at the door is the default because presale banks the money before the weather can touch it and tells you how much food to buy and how many shifts to fill, while the door still catches the families who decide that afternoon. Change it to presale only if the night is a seated auction in a fixed room — a festival should never turn a family away at the gate.',
      when: 'T-45d',
    ...
    },
    {
      ...
      defaultWhy: 'The volunteer stand is the default because every food dollar stays with the school. Change it if your volunteer bench is thin — food trucks bring their own permits and their own staff and hand back a share, and the split model lets the trucks do dinner while the stand sells the cheap high-margin treats.',
      when: 'T-45d',
