...
const ptaBoosterFundraiser = {
  ...
  tasks: [
    { id: 't_goal', milestoneId: 'pb_kickoff', phase: 'planning', label: 'Set the fundraising goal and write the one sentence that says what the money funds', when: 'T-120d' },
    ...
    { id: 't_facility', milestoneId: 'pb_facility', phase: 'venue', label: 'Submit the facility-use request to the school or district for the date, the rooms, and the grounds you need', when: 'T-120d' },
    { id: 't_custodian', milestoneId: 'pb_facility', phase: 'venue', label: 'Arrange custodial coverage for the night and ask what the after-hours fee will be', when: 'T-100d' },
    ...
    { id: 't_money_signoff', milestoneId: 'pb_approvals', phase: 'compliance', label: 'Walk the money plan past the principal or district office and follow their rules for cash on campus', when: 'T-90d' },
    ...
    { id: 't_signup', milestoneId: 'pb_volunteers', phase: 'planning', label: 'Send the volunteer sign-up home with the class lists and post it wherever the parents already are', when: 'T-45d' },
    ...
    { id: 't_presale_open', milestoneId: 'pb_presale', phase: 'revenue', label: 'Open presale for tickets and wristbands through the class lists, with a door price a little higher than presale', when: 'T-30d', whenChoice: { id: 'presale', in: ['Presale through the class lists, plus at the door', 'Presale only'] } },
    ...
    { id: 't_pickup_plan', milestoneId: 'pb_shifts', phase: 'planning', label: 'Write the pickup plan for close of night: where families collect kids, which doors are used, and who sweeps the building', when: 'T-10d' },
    { id: 't_float', milestoneId: 'pb_cash', phase: 'revenue', label: 'Get the float from the bank in small bills and coin, split across the cash boxes, and log the starting amount in each', when: 'T-2d' },
