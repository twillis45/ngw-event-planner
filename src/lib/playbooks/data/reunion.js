...
const reunion = {
  ...
  purchases: [
    ...
    { id: 'p_buns', item: 'Buns / rolls', category: 'food', qtyPerGuest: 1.5, unit: 'count', where: ['Costco', 'grocery'], unitCostRange: [0.3, 0.6], essential: false, buyAt: 'T-1d' , alternatives: ['Sliced white bread — cheaper standby', 'Tortillas — versatile, cheaper per serving'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_condiments', item: 'Condiments + serving staples (ketchup, mustard, etc.)', category: 'food', qtyFlat: 1, unit: 'set', where: ['Costco', 'grocery'], unitCostRange: [25, 45], essential: true, buyAt: 'T-3d', note: 'Host covers these regardless of food model.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_beer-wine', item: 'Beer / wine (where allowed)', category: 'beverage', qtyPerGuest: 1, unit: 'count', where: ['Costco', 'grocery', 'liquor store'], unitCostRange: [1.2, 3], essential: false, buyAt: 'T-3d', note: 'Only some guests drink alcohol; check the park’s alcohol policy first.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_paper', item: 'Plates, cups, napkins, utensils', category: 'cleanup', qtyPerGuest: 3, unit: 'set', where: ['Costco', 'dollar store', 'grocery'], unitCostRange: [0.15, 0.35], essential: true, buyAt: 'T-3d', note: '~3 of each per guest accounts for refills over a long event.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_nametags', item: 'Name tags + markers', category: 'logistics', qtyPerGuest: 1, unit: 'count', where: ['office store', 'dollar store', 'Amazon'], unitCostRange: [0.05, 0.15], essential: true, buyAt: 'T-3d', note: 'Multi-household crowd — name tags make introductions actually happen.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_signin', item: 'Sign-in / contact-update sheet + clipboard', category: 'logistics', qtyFlat: 1, unit: 'set', where: ['office store', 'Amazon'], unitCostRange: [5, 12], essential: true, buyAt: 'T-3d', note: 'Captures updated addresses/emails for the next reunion.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_sunblock', item: 'Sunscreen + bug spray (shared)', category: 'logistics', qtyFlat: 2, unit: 'count', where: ['grocery', 'pharmacy'], unitCostRange: [6, 12], essential: false, buyAt: 'T-3d', note: 'Outdoor all-ages crowd; someone always forgets theirs.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_games', item: 'Lawn games + kids supplies (cornhole, bubbles, balls)', category: 'decor', qtyFlat: 1, unit: 'set', where: ['Walmart', 'Target', 'Amazon'], unitCostRange: [30, 90], essential: false, buyAt: 'T-3d', note: 'Keeps all ages occupied; reusable for future reunions.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_tablecover', item: 'Disposable tablecloths', category: 'decor', qtyFlat: 1, qtyPer: 'per table', unit: 'count', where: ['dollar store', 'party store'], unitCostRange: [1, 3], essential: false, buyAt: 'T-3d', note: 'Cheap way to make picnic tables look intentional and speed cleanup.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_firstaid', item: 'Basic first-aid kit', category: 'logistics', qtyFlat: 1, unit: 'count', where: ['pharmacy', 'Amazon'], unitCostRange: [10, 25], essential: false, buyAt: 'T-3d', note: 'All-ages outdoor event — scrapes and bug bites are guaranteed.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
