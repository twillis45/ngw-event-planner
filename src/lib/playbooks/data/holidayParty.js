...
const holidayParty = {
  ...
  purchases: [
    ...
    { id: 'p_wine', item: 'Wine (red + white + a sparkling for the toast)', category: 'beverage', qtyFlat: 1, qtyPer: 4, unit: 'bottle per 4 guests', where: ['Wine shop', 'Total Wine', 'Grocery'], unitCostRange: [10, 22], essential: true, buyAt: 'T-3d', note: 'Board fix: was 1 bottle/2.5 guests (~40% over-buy). At ~1 drink/guest/hour × 30% wine over 4h ≈ 1.2 wine drinks/guest = 1 bottle (5 glasses) per ~4 guests; add sparkling for the toast.', provenance: { tier: 'heuristic', confidence: 'low', verificationStatus: 'synthesized', sources: [], note: 'US norm: 5 oz pour, 5 glasses/bottle.' } },
    ...
    { id: 'p_cleanup', item: 'Cleanup kit (trash + recycling bags, dish soap, paper towels, leftover containers)', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Costco'], unitCostRange: [12, 25], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: an extra recycling bag for bottles/cans + containers to send leftovers home.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
