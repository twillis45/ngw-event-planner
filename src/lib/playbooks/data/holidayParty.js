...
const holidayParty = {
  ...
  purchases: [
    { id: 'p_apps_hot', item: 'Hot heavy apps (meatballs, sliders, stuffed mushrooms, mini quiche)', category: 'food', qtyPerGuest: 5, unit: 'bites', where: ['Caterer', 'Costco', 'Grocery', 'Instacart'], unitCostRange: [0.8, 2.5], essential: true, buyAt: 'T-1d', note: 'Heavy-apps party = ~10-12 bites/guest total across hot + cold over the evening; hot items are the satisfying core.', provenance: 'US catering norm: 6-10 hors d’oeuvres/guest when apps replace a meal; heavier over a 3-4h evening.' },
    ...
    { id: 'p_dessert', item: 'Festive dessert bites (cookies, mini tarts, bark)', category: 'food', qtyPerGuest: 2, unit: 'bites', where: ['Bakery', 'Grocery', 'Caterer'], unitCostRange: [0.6, 2], essential: true, buyAt: 'T-1d' },
    ...
    { id: 'p_wine', item: 'Wine (red + white + a sparkling for the toast)', category: 'beverage', qtyFlat: 1, qtyPer: 2.5, unit: 'bottle per 2.5 guests', where: ['Wine shop', 'Total Wine', 'Grocery'], unitCostRange: [10, 22], essential: true, buyAt: 'T-3d', note: 'One 750ml bottle ≈ 5 glasses. ~30% of drinks as wine over 4h works out near 1 bottle per 2-3 guests; add sparkling for the toast.', provenance: 'US norm: 5 oz pour, 5 glasses/bottle.' },
