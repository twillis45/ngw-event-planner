...
const holidayParty = {
  ...
  purchases: [
    ...
    { id: 'p_nonalc', item: 'Sparkling water, soda & cider (mocktail base)', category: 'beverage', qtyPerGuest: 3, unit: 'drinks', where: ['Grocery', 'Costco'], unitCostRange: [0.6, 1.5], essential: true, buyAt: 'T-3d', note: 'A genuinely good zero-proof option is a liability mitigation, not an afterthought — designated drivers, non-drinkers, pregnant guests.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
