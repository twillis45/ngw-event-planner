...
const holidayParty = {
  ...
  purchases: [
    ...
    { id: 'p_flowers', item: 'Seasonal florals / centerpieces', category: 'decor', qtyFlat: 1, qtyPer: 12, unit: 'arrangement per 12 guests', where: ['Florist', 'Trader Joe’s', 'Costco'], unitCostRange: [15, 50], essential: false, buyAt: 'T-1d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
