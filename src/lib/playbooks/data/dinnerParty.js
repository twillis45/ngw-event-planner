...
const dinnerParty = {
  ...
  purchases: [
    ...
    { id: 'p_starch', item: 'Roast potatoes (or rice / risotto)', category: 'food', qtyPerGuest: 0.3, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 3], essential: true, buyAt: 'T-1d', alternatives: ['White rice or egg noodles — cheapest starch option', 'Roasted potatoes — budget-friendly, no special technique needed'] },
    { id: 'p_veg', item: 'Roasted vegetables & salad greens', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Farmers market'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', alternatives: ['Frozen roasted vegetables — cheaper, quick to prepare', 'Bagged salad mix — if time-pressed, still looks nice in a bowl'] },
    { id: 'p_appetizer', item: 'Cheese & charcuterie board (dips, crackers)', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Grocery', 'Cheese shop'], unitCostRange: [4, 9], essential: true, buyAt: 'T-3d', alternatives: ['Store-brand crackers + one good cheese — cheaper by half', 'Hummus + pita + olives — budget Mediterranean grazing option'] },
    ...
    { id: 'p_dessert', item: 'Bakery tart or cake (or ice cream & cookies)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Bakery', 'Grocery'], unitCostRange: [3, 7], essential: true, buyAt: 'T-1d', alternatives: ['Grocery bakery tart or cake — no baking required', 'Ice cream + store-bought cookies — simple, crowd-pleasing budget option'] },
    ...
    { id: 'p_nonalc', item: 'Sparkling water, mocktail & juice', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Grocery'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', note: 'Always have a great zero-proof option — designated drivers, non-drinkers, pregnant guests.' },
