...
const dinnerParty = {
  ...
  purchases: [
    { id: 'p_protein', item: 'Beef short rib (or salmon / mushroom wellington for veg)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Butcher', 'Grocery', 'Costco', 'Instacart'], unitCostRange: [8, 18], essential: true, buyAt: 'T-1d', alternatives: ['Roast chicken thighs — much cheaper, still impressive plated', 'Pork tenderloin — budget alternative to beef, elegant presentation', 'Pasta main with good sauce — cheapest option, guests love it'], substitutes: ['roast chicken (cheaper)', 'pasta course (cheapest)'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_starch', item: 'Roast potatoes (or rice / risotto)', category: 'food', qtyPerGuest: 0.3, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 3], essential: true, buyAt: 'T-1d', alternatives: ['White rice or egg noodles — cheapest starch option', 'Roasted potatoes — budget-friendly, no special technique needed'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_veg', item: 'Roasted vegetables & salad greens', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Farmers market'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', alternatives: ['Frozen roasted vegetables — cheaper, quick to prepare', 'Bagged salad mix — if time-pressed, still looks nice in a bowl'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_appetizer', item: 'Cheese & charcuterie board (dips, crackers)', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Grocery', 'Cheese shop'], unitCostRange: [4, 9], essential: true, buyAt: 'T-3d', alternatives: ['Store-brand crackers + one good cheese — cheaper by half', 'Hummus + pita + olives — budget Mediterranean grazing option'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_bread', item: 'Bread / rolls', category: 'food', qtyFlat: 1, qtyPer: 4, unit: 'loaf per 4 guests', where: ['Bakery', 'Grocery'], unitCostRange: [4, 8], essential: false, buyAt: 'T-1d', alternatives: ['Store-brand dinner rolls — fraction of bakery cost', 'Frozen par-baked rolls — bake day-of, cheaper than bakery'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_dessert', item: 'Bakery tart or cake (or ice cream & cookies)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Bakery', 'Grocery'], unitCostRange: [3, 7], essential: true, buyAt: 'T-1d', alternatives: ['Grocery bakery tart or cake — no baking required', 'Ice cream + store-bought cookies — simple, crowd-pleasing budget option'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_wine', item: 'Wine', category: 'beverage', qtyPerGuest: 0.5, unit: 'bottle (½ bottle/guest rule)', where: ['Wine shop', 'Total Wine', 'Grocery'], unitCostRange: [12, 25], essential: true, buyAt: 'T-3d', note: 'Rule of thumb: ½ bottle per drinking guest for a 3-4h dinner; round up.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_cocktail', item: 'Signature cocktail spirits + mixers + garnish', category: 'beverage', qtyFlat: 1, unit: 'batch (serves ~10)', where: ['Liquor store'], unitCostRange: [40, 70], essential: false, buyAt: 'T-3d', dependsOnDecision: 'alcohol' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_nonalc', item: 'Sparkling water, mocktail & juice', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Grocery'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', note: 'Always have a great zero-proof option — designated drivers, non-drinkers, pregnant guests.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_water', item: 'Table water service (pitcher / carafe, still & sparkling)', category: 'beverage', qtyFlat: 1, qtyPer: 6, unit: 'pitcher', where: ['Grocery', 'Home'], unitCostRange: [3, 8], essential: true, buyAt: 'T-1d', note: 'Board add: a seated dinner needs poured table water — ~1 pitcher/carafe per 6 guests, refilled through the meal.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_ice', item: 'Ice', category: 'beverage', qtyPerGuest: 1.5, unit: 'lb', where: ['Grocery', 'Gas station'], unitCostRange: [0.2, 0.4], essential: true, buyAt: 'T0', note: 'COMMONLY FORGOTTEN. ~1.5 lb/guest for chilling + drinks.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_coffee', item: 'Coffee + tea + cream/sugar', category: 'beverage', qtyFlat: 1, unit: 'service', where: ['Grocery'], unitCostRange: [6, 12], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_flowers', item: 'Centerpiece flowers', category: 'decor', qtyFlat: 1, qtyPer: 6, unit: 'arrangement per 6 guests', where: ['Florist', "Trader Joe's", 'Farmers market'], unitCostRange: [15, 45], essential: false, buyAt: 'T-1d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_candles', item: 'Candles (taper/tealight, unscented at the table)', category: 'decor', qtyFlat: 6, unit: 'candles', where: ['Grocery', 'Ikea', 'Amazon'], unitCostRange: [0.5, 3], essential: false, buyAt: 'T-3d', note: 'Unscented only at the table — scented competes with the food.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_napkins', item: 'Cloth or premium paper napkins', category: 'rental', qtyPerGuest: 1.5, unit: 'napkins', where: ['Have/borrow', 'Grocery'], unitCostRange: [0.3, 2], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_paper', item: 'Paper goods (cocktail napkins, parchment, foil, food storage containers for leftovers)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Costco'], unitCostRange: [10, 20], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: leftover containers for sending food home.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_dish', item: 'Dish soap, sponges, trash + recycling bags', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [8, 15], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: extra trash bags + a recycling bag for bottles.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
