...
const cardParty = {
  ...
  purchases: [
    ...
    { id: 'p_trash', item: 'Trash + recycling bags', category: 'cleanup', qtyFlat: 1, qtyPer: 6, unit: 'roll/kit', where: ['Grocery'], unitCostRange: [3, 7], essential: true, buyAt: 'T-1d', note: 'COMMONLY FORGOTTEN: a 4h grazing night fills bags. Have 3-4 ready so you can swap mid-night without a hunt.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
