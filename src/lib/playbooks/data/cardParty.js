...
const cardParty = {
  ...
  purchases: [
    ...
    { id: 'p_deviled', item: 'Deviled eggs (the classic — half an egg per guest)', category: 'food', qtyPerGuest: 1, unit: 'half', where: ['Grocery'], unitCostRange: [0.25, 0.5], essential: false, buyAt: 'T-1d', note: 'A card-table staple. Plan ~1-2 halves/guest; they go fast. Make-ahead the day before.', alternatives: ['Hard-boiled eggs with salt — if short on time, simpler version'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
