...
const cardParty = {
  ...
  purchases: [
    ...
    { id: 'p_water', item: 'Water + sparkling water + soda (over-stock these)', category: 'beverage', qtyPerGuest: 3, unit: 'can/bottle', where: ['Grocery', 'Costco'], unitCostRange: [0.4, 1.25], essential: true, buyAt: 'T-1d', note: 'A thinking game runs on water and soda as much as liquor — over-stock; many guests stay non-alcoholic the whole night.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
