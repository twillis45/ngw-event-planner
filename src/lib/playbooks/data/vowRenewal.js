...
const vowRenewal = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host / family cooks', 'Caterer', 'Potluck reception', 'Restaurant'], default: 'Caterer', when: 'T-30d', blocks: ['food', 'vendors'], costFactors: { 'Host / family cooks': 0.7, 'Potluck reception': 0.55, 'Restaurant': 1.15 }, affects: ['p_apps', 'p_protein', 'p_sides', 'p_bread'], why: 'A renewal reception usually means a caterer or restaurant; an intimate at-home one can be host-cooked.' },
