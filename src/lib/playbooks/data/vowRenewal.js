...
const vowRenewal = {
  ...
  purchases: [
    ...
    { id: 'p_protein', item: 'Main protein (for a seated/meal format — beef/chicken/salmon + a veg main)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Butcher', 'Grocery', 'Costco', 'Caterer'], unitCostRange: [7, 16], essential: false, buyAt: 'T-1d', note: '~0.4 lb (6-8 oz) cooked protein per seated guest. Skip if the format is apps-only.', provenance: { tier: 'consensus', confidence: 'med', verificationStatus: 'synthesized', note: 'US wedding-catering consensus: 6-8 oz entree protein per guest.' } },
    { id: 'p_sides', item: 'Sides / salads / starch', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Farmers market'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', provenance: { tier: 'consensus', confidence: 'med', verificationStatus: 'synthesized', note: '4-6 oz per side per guest is the standard catering portion.' } },
    { id: 'p_bread', item: 'Bread / rolls / crackers', category: 'food', qtyFlat: 1, qtyPer: 4, unit: 'loaf/box per 4 guests', where: ['Bakery', 'Grocery'], unitCostRange: [4, 8], essential: false, buyAt: 'T-1d', provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized', note: 'Planning heuristic; varies with menu.' } },
    { id: 'p_cake', item: 'Vow-renewal cake (message / years married)', category: 'food', qtyFlat: 1, qtyPer: 25, unit: 'cake per ~25 guests', where: ['Bakery', 'Grocery bakery'], unitCostRange: [45, 140], essential: true, buyAt: 'T-1d', note: 'Order ~1-2 weeks ahead. An 8" serves ~15-24; a 2-tier serves ~25-40.', provenance: { tier: 'consensus', confidence: 'med', verificationStatus: 'synthesized', note: 'Standard cake-yield guidance.' } },
