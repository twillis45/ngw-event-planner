...
const vowRenewal = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host / family cooks', 'Caterer', 'Potluck reception', 'Restaurant'], default: 'Caterer', when: 'T-30d', blocks: ['food', 'vendors'], why: 'A renewal reception usually means a caterer or restaurant; an intimate at-home one can be host-cooked.' },
