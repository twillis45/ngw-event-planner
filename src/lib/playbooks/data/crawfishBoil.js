...
const crawfishBoil = {
  ...
  purchases: [
    ...
    { id: 'p_drinks', item: 'Cold beer, soda, water', category: 'beverage', qtyPerGuest: 4, unit: 'drinks', where: ['Grocery', 'Costco/Sam\'s'], unitCostRange: [0.7, 2], essential: true, buyAt: 'T-3d', note: 'Cold beer is the boil drink; soda + water for everyone. It\'s a long, hot afternoon — over-buy water.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: '~4 drinks/guest over a 5h spring afternoon outdoors.', claim: 'Guests consume ~4 drinks each over a 5-hour outdoor spring crawfish boil', sufficientWhen: 'Verified against outdoor event beverage consumption norms for a 5h warm-weather afternoon gathering' } },
    { id: 'p_ice', item: 'Ice (drinks + coolers)', category: 'beverage', qtyPerGuest: 2.5, unit: 'lb', where: ['Grocery', 'Gas station', 'Ice house'], unitCostRange: [0.2, 0.4], essential: true, buyAt: 'T0', note: 'COMMONLY UNDER-BOUGHT. A spring boil burns through ice — ~2.5 lb/guest for cold drinks (more on a hot day).' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
