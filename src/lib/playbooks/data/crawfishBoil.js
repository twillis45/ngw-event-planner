...
const crawfishBoil = {
  ...
  decisions: [
    ...
    { id: 'cookmethod', label: 'Boil it yourself or order it cooked?', options: ['Boil it yourself (propane pot)', 'Order live + boil yourself', 'Order it boiled by the pound (pickup)'], default: 'Boil it yourself (propane pot)', when: 'T-10d', blocks: ['food', 'logistics'], costFactors: { 'Order it boiled by the pound (pickup)': 1.6 }, affects: ['p_crawfish'], why: 'Boiling yourself is the tradition and the fun, but it needs the pot, the burner, the propane, and someone running it for hours. Ordering it already boiled by the pound from a seafood place is a real, common shortcut when you don\'t have the rig or the time.' },
    ...
    { id: 'heat', label: 'Seasoning heat level', options: ['Mild (family / kids)', 'Medium (classic)', 'Hot (Louisiana hot)', 'Two batches — mild + hot'], default: 'Medium (classic)', when: 'T-7d', blocks: ['food'], costFactors: { 'Mild (family / kids)': 0.9, 'Hot (Louisiana hot)': 1.15, 'Two batches — mild + hot': 1.3 }, affects: ['p_season'], why: 'The seasoning (Zatarain\'s or Louisiana Fish Fry crab/crawfish boil + cayenne + lemon + salt) carries the whole dish, and heat is personal. A mild-and-hot split keeps kids and tender mouths happy without dialing the whole pot down.' },
    { id: 'sides', label: 'What goes in the pot with the crawfish?', options: ['Red potatoes + corn + smoked sausage', 'Add onions, garlic, mushrooms', 'Add the works (lemons, artichoke, Brussels)'], default: 'Add onions, garlic, mushrooms', when: 'T-7d', blocks: ['food'], costFactors: { 'Red potatoes + corn + smoked sausage': 0.55, 'Add the works (lemons, artichoke, Brussels)': 1.4 }, affects: ['p_aromatics'], why: 'The classics — small red potatoes, corn on the cob, smoked sausage or andouille — boil right alongside. Onions, whole garlic, mushrooms, and halved lemons go in too. The fixings soak up as much seasoning as the crawfish, so most cooks add more than they think.' },
    { id: 'drinks', label: 'Drinks', options: ['Cold beer + soda + water', 'Add a non-alcoholic / kids spread', 'Beer + soda + water + ice tea'], default: 'Cold beer + soda + water', when: 'T-7d', blocks: ['beverage'], costFactors: { 'Add a non-alcoholic / kids spread': 1.15, 'Beer + soda + water + ice tea': 1.05 }, affects: ['p_drinks'], why: 'Cold beer is the crawfish-boil drink, with soda, water, and plenty of ice for everybody. It\'s a long afternoon outside in spring — over-buy ice and water, not just beer.' },
  ],
