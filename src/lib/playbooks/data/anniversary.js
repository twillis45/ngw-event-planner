...
const anniversary = {
  ...
  purchases: [
    { id: 'p_apps', item: 'Heavy passed + stationed appetizers (cheese, charcuterie, crudite, sliders, skewers, dips)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Costco', 'Caterer', 'Instacart'], unitCostRange: [5, 11], essential: true, buyAt: 'T-1d', note: 'For a PARTY format, heavy apps must be a meal: plan ~10-12 pieces/guest across stations.', provenance: 'synthesized' },
    { id: 'p_protein', item: 'Main protein (for a seated/dinner format — beef/chicken/salmon + a veg main)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Butcher', 'Grocery', 'Costco', 'Caterer'], unitCostRange: [7, 16], essential: false, buyAt: 'T-1d', note: '~0.4 lb cooked protein per seated guest. Skip if the format is apps-only.', provenance: 'synthesized' },
    { id: 'p_sides', item: 'Sides / salads / starch', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Farmers market'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', provenance: 'synthesized' },
    { id: 'p_bread', item: 'Bread / rolls / crackers', category: 'food', qtyFlat: 1, qtyPer: 4, unit: 'loaf/box per 4 guests', where: ['Bakery', 'Grocery'], unitCostRange: [4, 8], essential: false, buyAt: 'T-1d', provenance: 'synthesized' },
    { id: 'p_cake', item: 'Anniversary cake (milestone message / year)', category: 'food', qtyFlat: 1, qtyPer: 20, unit: 'cake per ~20 guests', where: ['Bakery', 'Grocery bakery'], unitCostRange: [40, 120], essential: true, buyAt: 'T-1d', note: 'Order ~1-2 weeks ahead. A 2-tier serves ~25-40; an 8" serves ~15-24.', provenance: 'synthesized' },
    ...
    { id: 'p_nonalc', item: 'Non-alcoholic options (sparkling water, mocktail, juice, soda)', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Grocery'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', note: 'Anniversary lists skew older — always have a great zero-proof pour for the toast too.', provenance: 'synthesized' },
    ...
    { id: 'p_coffee', item: 'Coffee + tea service (for cake)', category: 'beverage', qtyFlat: 1, unit: 'service', where: ['Grocery'], unitCostRange: [6, 12], essential: true, buyAt: 'T-3d', provenance: 'synthesized' },
