...
const anniversary = {
  ...
  purchases: [
    ...
    { id: 'p_sides', item: 'Sides / salads / starch', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Farmers market'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', alternatives: ['Costco prepared sides — saves time and often cheaper', 'Roasted root vegetables — budget-friendly, seasonal'], provenance: 'synthesized' },
