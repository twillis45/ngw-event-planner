...
const birthday = {
  ...
  purchases: [
    ...
    { id: 'p_alcohol', item: 'Beer / wine (adult parties)', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Liquor store', 'Grocery'], unitCostRange: [3, 6], essential: false, buyAt: 'T-3d', dependsOnDecision: 'alcohol' },
