...
const birthday = {
  ...
  purchases: [
    ...
    { id: 'p_veggietray', item: 'Veggie tray', category: 'food', qtyFlat: 1, unit: 'tray (serves 12-16)', where: ['Grocery deli'], unitCostRange: [20, 50], essential: false, buyAt: 'T-1d', note: 'Split out 2026-08-18 — sourced only to aggregator sites summarizing the same Walmart deli program, not independently corroborated, so this band is an estimate pending a second real source.', provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_salad', item: 'Salad', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Grocery'], unitCostRange: [1, 3], essential: false, buyAt: 'T-1d', note: 'Split out 2026-08-18 — no corroborated pricing found yet; band is an unverified estimate.', alternatives: ['Pre-made pasta salad from deli — if running short on prep time'], provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
