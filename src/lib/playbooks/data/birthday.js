...
const birthday = {
  ...
  decisions: [
    ...
    { id: 'food_style', label: 'Food style', options: ['Cook/grill yourself', 'Order pizza/trays', 'Drop-off catering', 'Potluck'], default: 'Order pizza/trays', when: 'T-10d', blocks: ['food', 'vendors'], costFactors: { 'Cook/grill yourself': 1.1, 'Drop-off catering': 1.3, 'Potluck': 0.5 }, affects: ['p_mains'], why: 'The biggest effort/cost lever. Trays or drop-off removes the riskiest day-of cooking.' },
