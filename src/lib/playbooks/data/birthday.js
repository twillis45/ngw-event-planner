...
const birthday = {
  ...
  decisions: [
    ...
    { id: 'food_style', label: 'Food style', options: ['Cook/grill yourself', 'Order pizza/trays', 'Drop-off catering', 'Potluck'], default: 'Order pizza/trays', when: 'T-10d', blocks: ['food', 'vendors'], costViaApproach: true, why: 'The biggest effort/cost lever. Trays or drop-off removes the riskiest day-of cooking.' },
