...
const bacheloretteParty = {
  ...
  purchases: [
    ...
    { id: 'p_spirits', item: 'Liquor for the batch cocktail (vodka/tequila/gin) + a bottle for shots', category: 'beverage', qtyPerGuest: 0.18, unit: 'bottle (750ml)', where: ['Liquor store', 'Costco', 'Total Wine'], unitCostRange: [15, 30], essential: false, buyAt: 'T-3d', note: 'For the at-home pre-game only — plan ~1 drink/guest/hr for the ~2 pre-game hours. ~1 750ml bottle (≈16 drinks) per 5–6 guests. Pace, do not over-buy; the night out has its own bar tab.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: 'US party heuristic: ~1 drink/guest/hr (2 in the first hour); ~16 cocktails per 750ml bottle.', claim: 'A 750ml bottle yields ~16 cocktails and planning ~1 drink/guest/hr (2 in hour one) covers a 2-hour at-home pre-game for a small group', sufficientWhen: 'bar guides or responsible-hosting resources confirm ~16 standard 1.5oz-pour cocktails per 750ml bottle and the 1 drink/guest/hr pacing rate' } },
    { id: 'p_bubbly', item: 'Sparkling wine / prosecco for the toast + mimosas', category: 'beverage', qtyPerGuest: 0.25, unit: 'bottle (750ml)', where: ['Grocery', 'Liquor store', 'Costco'], unitCostRange: [10, 18], essential: false, buyAt: 'T-3d', note: '~1 bottle per 4 guests covers a welcome toast and a light pour; the bride\'s glass is the centerpiece.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
