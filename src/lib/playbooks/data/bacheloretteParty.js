...
const bacheloretteParty = {
  ...
  decisions: [
    { id: 'format', label: 'Night out vs. weekend trip', options: ['One big night out (local)', 'Overnight (Airbnb / hotel suite)', 'Full weekend trip'], default: 'One big night out (local)', when: 'T-30d', blocks: ['lodging', 'transport', 'itinerary', 'beverage_purchases'], weight: 'high', reversibility: 'costly', emotionalWeight: 'low', difmCapable: 'needs-host', priorityBasis: { rationale: 'One night out versus a weekend trip is the spine — it sets lodging, how many transport legs you book, and how big the split gets, so scope and budget hang on it.', tier: 'reasoned' }, why: 'This is the spine decision: it sets lodging, how many nights of transport you book, how big the cost-split is, and whether the pre-game is at home or in a rented suite.' },
    { id: 'costsplit', label: 'Budget + cost-split model (who pays for what; cover the bride)', options: ['Even split, group covers the bride', 'Even split, bride pays her own', 'Tiered (each pays own + chips in for bride)', 'Host fronts, collect via app'], default: 'Even split, group covers the bride', when: 'T-30d', blocks: ['lodging', 'transport', 'itinerary'], weight: 'med', reversibility: 'reversible', emotionalWeight: 'low', difmCapable: 'needs-host', priorityBasis: { rationale: 'Money is the number-one friction on a bachelorette, so the per-person number and the cover-the-bride rule have to be agreed in writing before anyone books.', tier: 'reasoned' }, why: 'Bachelorette costs spiral and money is the #1 friction. Agree the per-person number and the "do we cover the bride" rule UP FRONT, in writing, before anyone books — traditionally the group splits the bride\'s share, travel excepted.' },
    { id: 'vibe', label: 'Bride\'s vibe / non-negotiables', options: ['Bar/club crawl', 'Dinner + drinks', 'Boat/pool day + night out', 'Low-key / spa + wine'], default: 'Dinner + drinks', when: 'T-30d', blocks: ['itinerary', 'reservations'], deliversHeartMoment: true, weight: 'med', reversibility: 'reversible', emotionalWeight: 'high', difmCapable: 'needs-host', priorityBasis: { rationale: 'This is the bride\'s night — confirming what she actually wants, and her hard nos, is what makes her feel celebrated rather than managed.', tier: 'reasoned' }, why: 'Confirm with the bride (privately) what she actually wants and any hard nos — this drives the reservation, the games, and the energy of the night.' },
    { id: 'dinner', label: 'Dinner reservation vs. club/bar plan', options: ['Sit-down dinner reservation', 'Dinner then club', 'Bar crawl (no formal dinner)', 'Private chef at the Airbnb'], default: 'Dinner then club', when: 'T-21d', blocks: ['reservations', 'transport'], weight: 'med', reversibility: 'costly', emotionalWeight: 'low', difmCapable: 'needs-host', priorityBasis: { rationale: 'Large-group reservations book out well ahead and take a card or deposit, so committing the dinner-versus-club plan early is a real booking the host owns.', tier: 'reasoned' }, why: 'Large-group reservations book out weeks ahead and most venues require a card/deposit; the choice also sets how many transport legs you pre-book.' },
    { id: 'drinkers', label: 'Drinking mix + dietary/no-alcohol needs', options: ['Mostly drinking', 'Mixed', 'Several non-drinkers / pregnant / sober'], default: 'Mixed', when: 'T-14d', blocks: ['beverage_purchases'], weight: 'med', reversibility: 'reversible', emotionalWeight: 'med', difmCapable: 'needs-host', priorityBasis: { rationale: 'Knowing who is drinking, pregnant, or sober sets the batch size and guarantees an equally good zero-proof pour so no one — including the sober lead — is left out.', tier: 'reasoned' }, why: 'Sets the batch-cocktail size AND guarantees a great zero-proof option, plenty of water, and food — never leave a non-drinker (or the designated sober lead) without an equally good pour.' },
  ],
  ...
  purchases: [
    { id: 'p_apps', item: 'Cheese & cured meats board (dips, crackers, fruit, veg)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery', 'Costco', 'Caterer'], unitCostRange: [5, 12], essential: true, buyAt: 'T-1d', note: 'Food is a SAFETY tool — a real grazing board for the pre-game keeps people eating while they drink and slows the night down.', alternatives: ['Costco deli platter — cheaper per lb, same grazing function', 'Trader Joe\'s appetizer section — budget-friendly, pre-made bites', 'Hummus + veggie tray + crackers — cheapest spread option'], costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['charcuterie-ica-2026', 'charcuterie-grocery-2026'], lastVerified: '2026-08-15', claim: 'A mixed cheese-and-cured-meat grazing board runs $5-12/lb in ingredients: ICA per-pound 2026 puts budget cheese at $5-15 and crowd-pleasers at $10-25, salami $10-25 and mortadella $8-20, with fruit, nuts and olives $1-15; grocery averages run ~$15/lb cheese and ~$20/lb meats, and a DIY medium board for 5-15 people lands at $50-120 in ingredients.', sufficientWhen: 'Current shelf prices for two mid-range cheeses and two cured meats at one national grocer confirm the $5-12/lb blended ingredient range.' }, provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~0.5 lb grazing/guest for a pre-dinner pre-game board.', claim: '~0.5 lb of cheese/charcuterie grazing board per guest is sufficient for a 2-hour pre-dinner pre-game', sufficientWhen: 'hosting guides or catering references for a grazing board accompanying drinking before dinner confirm the 0.5 lb/guest range' } },
    { id: 'p_spirits', item: 'Liquor for the batch cocktail (vodka/tequila/gin) + a bottle for shots', category: 'beverage', qtyPerGuest: 0.18, unit: 'bottle (750ml)', where: ['Liquor store', 'Costco', 'Total Wine'], unitCostRange: [13, 36], essential: false, buyAt: 'T-3d', note: 'For the at-home pre-game only — plan ~1 drink/guest/hr for the ~2 pre-game hours. ~1 750ml bottle (≈16 drinks) per 5–6 guests. Pace, do not over-buy; the night out has its own bar tab.', costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['spirits-budgetbar-2026', 'spirits-retail-2026'], lastVerified: '2026-08-15', claim: 'A 750ml party bottle of vodka, tequila or gin runs $13-36: budget shelf bottles are $12.95-15.95 (SKYY, Seagram\'s, Bacardi), blanco tequila clusters at $20.95-21.95, and popular-brand gin tops the range at $30.99-36.60.', sufficientWhen: 'Re-checked against named shelf prices and retail guides. Store brands from ~$8 sit below this band and premium/limited bottles to $60 sit above it. The fetched prices are North Carolina and exclude tax; spirits pricing is state-regulated, so a control state will read differently and this wants re-checking regionally, not just on the 45-day pricing window.' } },
    { id: 'p_bubbly', item: 'Sparkling wine / prosecco for the toast + mimosas', category: 'beverage', qtyPerGuest: 0.25, unit: 'bottle (750ml)', where: ['Grocery', 'Liquor store', 'Costco'], unitCostRange: [10, 25], essential: false, buyAt: 'T-3d', note: '~1 bottle per 4 guests covers a welcome toast and a light pour; the bride\'s glass is the centerpiece.' , costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['sparklingwine-band-2026', 'costhelper-champagne-2026'], lastVerified: '2026-08-15', claim: 'Sparkling wine and prosecco run $10-25 per 750ml bottle: budget sparkling is $10-15 (CostHelper puts California sparkling near $5 and Spanish cava near $14), and the general sparkling average is $15-25.', sufficientWhen: 'Re-checked against retail sparkling pricing. THIS IS NOT CHAMPAGNE and the band is deliberately lower than a champagne toast line for that reason - true Champagne from the region starts at $30-40 and runs to $500. Excludes corkage, which a venue charges separately at $1+ per bottle.' } },
    { id: 'p_mixers', item: 'Mixers + garnishes (juice, soda, citrus, simple syrup) for the batch cocktail', category: 'beverage', qtyPerGuest: 0.5, unit: 'L', where: ['Grocery', 'Costco'], unitCostRange: [1.5, 4], essential: false, buyAt: 'T-1d', note: 'Doubles as the base for the zero-proof version of the signature drink.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['mixers-retail-2026', 'soda-12pack-2026'], lastVerified: '2026-08-16', claim: 'Bar mixers at retail 2026: Canada Dry tonic water 1L $1.99 and ginger ale 2L $2.99 ($0.04 per fluid ounce), with club soda in the same formats at comparable shelf prices; a 12-pack of soda runs $3.00-6.50, about $0.25-0.60 a can. A mixer allowance of roughly $2-3 a bottle covers tonic, club soda, ginger ale and cola alike.', sufficientWhen: 'Current shelf prices for one bottle each of tonic and ginger ale at a national retailer confirm the per-bottle range.' } },
    { id: 'p_water', item: 'Water + electrolyte drinks (bottled water, sparkling, Liquid I.V. / Gatorade)', category: 'beverage', qtyPerGuest: 4, unit: 'bottles/servings', where: ['Grocery', 'Costco'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-1d', note: 'SAFETY-ESSENTIAL: one water per drink, plus electrolytes for the morning. Set a visible water station — this is the single most effective over-serving mitigation.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_zeroproof', item: 'Zero-proof / mocktail base + N/A bubbly for non-drinkers & the sober lead', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Grocery'], unitCostRange: [0.75, 3], essential: true, buyAt: 'T-3d', note: 'Make the mocktail as good as the cocktail — the designated sober point person and any non-drinkers/pregnant guests should never feel left out.' , costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['zeroproof-retail-2026', 'nabeer-retail-2026'], lastVerified: '2026-08-15', claim: 'A zero-proof drink runs $0.75-3.00 poured at home: a simple juice-and-soda mocktail sits at the floor, NA beer is $2.17-2.50 a can (Athletic $13 a six-pack, Budweiser AF $29.99 a twelve), and a drink built on an NA spirit costs about $1.60-2.20 in spirit alone since a $25-35 bottle pours roughly sixteen.', sufficientWhen: 'Re-checked against NA spirit, NA beer and canned-mocktail retail. BAR PRICING IS EXCLUDED AND MUST STAY EXCLUDED - zero-proof drinks run $13-17 at bars, which is hospitality pricing for a served drink and would inflate this band roughly tenfold. Premium canned mocktails at about $8 a serving also sit above it.' } },
    { id: 'p_ice', item: 'Ice', category: 'beverage', qtyPerGuest: 1.5, unit: 'lb', where: ['Grocery', 'Gas station'], unitCostRange: [0.2, 0.4], essential: true, buyAt: 'T0', note: 'COMMONLY FORGOTTEN. ~1.5 lb/guest for the batch cocktail, chilling bubbly, and the water station.', provenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'researched', sources: ['bar-provision-2026'], note: 'Grounded to bar-provision-2026: ~1.5 lb ice/guest is the source-stated ice provisioning rate.', claim: '~1.5 lb of ice per guest covers a batch cocktail, chilling bubbly, and a water station at a small indoor pre-game', sufficientWhen: '2+ hosting guides or bartender resources confirm the 1.5 lb/guest range for cocktail service plus chilling' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['ice-retail-2026', 'ice-warehouse-2026'], lastVerified: '2026-08-16', claim: 'Bagged ice 2026: warehouse clubs run 10-12c per pound (a 20lb bag is $1.75-2.50 at Sams Club, $1.80-2.50 at Costco); grocery and gas-station bags cluster 23-31c/lb (BJs and 7-Eleven 20lb about $4.49-4.79, Giant 20lb $4.99, Publix 16lb $4.99); small bags and hardware stores reach 41-45c/lb. Convenience ice is more than four times warehouse ice per pound.', sufficientWhen: 'Current shelf prices for one 20lb bag at a warehouse club and one at a grocery store confirm the per-pound spread.' } },
    { id: 'p_sash', item: 'Bride sash + bachelorette banner + photo-wall decor', category: 'decor', qtyFlat: 1, unit: 'kit', where: ['Amazon', 'Party store', 'Etsy', 'Target'], unitCostRange: [20, 60], essential: true, buyAt: 'T-3d', note: 'The bride sash is the signature item — plus a "Bride" banner and a small backdrop for photos.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_decor', item: 'Theme decor (balloons, confetti, table accents, tiaras)', category: 'decor', qtyFlat: 1, qtyPer: 8, unit: 'kit per 8 guests', where: ['Party store', 'Amazon', 'Target'], unitCostRange: [25, 70], essential: false, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_favors', item: 'Party favors / matching items (matching tees, sunnies, koozies, totes, hangover kits)', category: 'decor', qtyPerGuest: 1, unit: 'set', where: ['Etsy', 'Amazon', 'Party store'], unitCostRange: [6, 22], essential: false, buyAt: 'T-3d', note: 'Matching tees/sunnies make the group photos AND make the crew easy to spot/keep together out at night (a low-key safety bonus).' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_games', item: 'Bachelorette games + dares/prompt cards + small prizes', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Amazon', 'Etsy', 'Party store'], unitCostRange: [12, 35], essential: false, buyAt: 'T-3d', dependsOnDecision: 'vibe' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_tableware', item: 'Cups, shot glasses, flutes, plates, napkins, cutlery', category: 'rental', qtyPerGuest: 2, unit: 'set', where: ['Grocery', 'Party store', 'Costco'], unitCostRange: [0.4, 2], essential: true, buyAt: 'T-3d', note: 'Include flutes for the toast and cups clearly distinct from the water cups.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' }, costProvenance: { tier: 'researched', confidence: 'medium', verificationStatus: 'cited', sources: ['disposables-bulk-2026', 'disposables-partyqty-2026'], lastVerified: '2026-08-16', claim: 'Disposable tableware runs about 6 cents a plate in bulk packs (roughly $18 per 300) and $0.25-0.40 a plate at a grocery store, with bulk restaurant supply at $0.08-0.15; cups, cutlery and napkins bought in bulk alongside them save $100-200 across a party.', sufficientWhen: 'Current shelf prices for one bulk plate pack and the same item at a grocery store confirm the per-piece spread.' } },
    { id: 'p_paper', item: 'Paper goods (tablecloths, foil, ziplocks, gift/leftover bags, trash bags)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Costco'], unitCostRange: [8, 20], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_safetykit', item: 'Safety + recovery kit (portable phone chargers, OTC pain reliever, antacids, band-aids, snacks, sealed water for the ride home)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Pharmacy', 'Grocery', 'Amazon'], unitCostRange: [15, 40], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: a charged phone is a safety device. Keep chargers, water, and snacks in the bride\'s bag and the sober lead\'s bag.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_cleanup', item: 'Trash + recycling bags, paper towels, wipes (Airbnb-reset friendly)', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [7, 18], essential: true, buyAt: 'T-3d', note: 'Leave the suite clean to protect the deposit — assign the reset before anyone leaves.' , costProvenance: { tier: 'researched', confidence: 'low', verificationStatus: 'cited', sources: ['costco-cleaning-2026', 'trashbags-retail-2026'], lastVerified: '2026-08-15', claim: 'A cleanup kit runs $7-18 as the SUM of its parts: about a dozen trash and recycling bags at 10 cents each from a warehouse or 11-15 cents at grocery, two rolls of paper towels at about $1.97 warehouse, and a canister of wipes at about $4.27 or a dish-soap pack at $14.74 shared across events.', sufficientWhen: 'CONFIDENCE IS LOW ON PURPOSE: no source prices a cleanup kit, because nobody sells one. This band is a sum of individually-priced components, so treat it as an envelope rather than a quote. The spread is the CHANNEL - warehouse packs against a grocery shelf - and a host who already owns soap and towels lands well under the floor. Kits that also carry gloves, foil or to-go containers are a different bundle.' } },
  ],
