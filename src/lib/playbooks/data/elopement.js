...
const elopement = {
  ...
  purchases: [
    ...
    { id: 'p_meal', item: 'Small celebratory meal (picnic, reservation, or to-go)', category: 'food', qtyPerGuest: 1, unit: 'meal', where: ['Restaurant', 'Caterer', 'Grocery / deli'], unitCostRange: [25, 120], essential: true, buyAt: 'T-1d', note: 'No reception — this is the celebration. A reservation for two, a curated picnic, or a private chef all work. Reserve ahead if dining out.' , alternatives: ['Picnic from local deli or grocery — romantic, budget-friendly', 'Farmers market spread — seasonal, meaningful, often cheaper than restaurant'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
