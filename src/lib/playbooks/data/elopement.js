...
const elopement = {
  ...
  purchases: [
    ...
    { id: 'p_glasses', item: 'Two toast glasses (packable/unbreakable)', category: 'rental', qtyFlat: 2, unit: 'glasses', where: ['Online', 'Outdoor store', 'Home'], unitCostRange: [10, 40], essential: false, buyAt: 'T-3d', note: 'Bring your own — remote sites have nothing. Unbreakable/stemless travels best.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
