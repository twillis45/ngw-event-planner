...
const elopement = {
  ...
  purchases: [
    ...
    { id: 'p_bouquet', item: 'Bouquet / boutonniere / simple florals', category: 'decor', qtyFlat: 1, unit: 'set', where: ['Florist', 'Grocery', 'Farmers market'], unitCostRange: [40, 150], essential: false, buyAt: 'T-1d', note: 'The one styling element that reads in every photo. Keep it small and packable for travel.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
