...
const elopement = {
  ...
  purchases: [
    ...
    { id: 'p_rings', item: 'Wedding rings', category: 'logistics', qtyFlat: 2, unit: 'rings', where: ['Jeweler', 'Online'], unitCostRange: [100, 2000], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN day-of: pack the rings and the license folder FIRST. Order/size rings weeks ahead; carry them on your person when traveling, never checked.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_keepsakes', item: 'Vow books, marriage license folder, ring box', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Online', 'Stationery store'], unitCostRange: [15, 50], essential: false, buyAt: 'T-3d', note: 'Vow books photograph beautifully and keep written vows safe. A document folder protects the license in a pack/pocket.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
