...
const elopement = {
  ...
  decisions: [
    ...
    { id: 'tell_family', label: 'Whether / how to tell family', options: ['Tell beforehand', 'Tell after (announcement)', 'Invite a few to attend', 'Private — share photos later'], default: 'Tell after (announcement)', when: 'T-60d', weight: 'med', reversibility: 'costly', emotionalWeight: 'high', difmCapable: 'needs-host', priorityBasis: { rationale: 'How and when family hears is the emotional core of an elopement — an intentional, hard-to-walk-back choice only the couple can own.', tier: 'reasoned' }, why: 'The emotional core of an elopement. Decide intentionally: who hears before, who hears after, and how — so the choice feels owned, not like an accident someone discovers.' },
