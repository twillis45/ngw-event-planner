...
const babyShower = {
  ...
  purchases: [
    ...
    { id: 'p_tableware', item: 'Plates, cups, napkins, cutlery + linens', category: 'rental', qtyPerGuest: 1.5, unit: 'set', where: ['Grocery', 'Party store', 'Costco'], unitCostRange: [0.5, 2], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
