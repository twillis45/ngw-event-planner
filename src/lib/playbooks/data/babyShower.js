...
const babyShower = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host makes a brunch spread', 'Drop-off catering', 'Potluck', 'Order platters'], default: 'Host makes a brunch spread', when: 'T-21d', blocks: ['food', 'vendors'], costFactors: { 'Drop-off catering': 1.35, 'Potluck': 0.55, 'Order platters': 1.15 }, affects: ['p_food'], why: 'A daytime shower is grazing food — easy to host-make, or a drop-off if the guest list is big.' },
