...
const babyShower = {
  ...
  purchases: [
    ...
    { id: 'p_games', item: 'Game / activity supplies + prizes', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Amazon', 'Party store'], unitCostRange: [15, 40], essential: false, buyAt: 'T-3d', dependsOnDecision: 'games' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
