...
const babyShower = {
  ...
  purchases: [
    ...
    { id: 'p_flowers', item: 'Centerpiece flowers', category: 'decor', qtyFlat: 1, qtyPer: 8, unit: 'arrangement per 8 guests', where: ['Florist', "Trader Joe's", 'Grocery'], unitCostRange: [15, 40], essential: false, buyAt: 'T-1d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
