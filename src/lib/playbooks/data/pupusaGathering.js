...
const pupusaGathering = {
  ...
  purchases: [
    ...
    { id: 'p_chicharron', item: 'Chicharrón (ground pork) for revueltas', category: 'food', qtyPerGuest: 0.15, unit: 'lb', where: ['Latin market', 'Butcher'], unitCostRange: [4, 8], essential: false, buyAt: 'T-3d', note: 'Ground/cooked pork for revueltas. Skip for the veg-friendly spread.', alternatives: ['Ground pork + salt — DIY chicharron filling, much cheaper', 'Skip it — frijol con queso is the vegetarian option that everyone can eat'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
