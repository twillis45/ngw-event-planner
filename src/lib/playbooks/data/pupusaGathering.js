...
const pupusaGathering = {
  ...
  decisions: [
    { id: 'make_vs_order', label: 'Make from scratch, order, or hybrid?', options: ['Make all from scratch (comal day)', 'Order from a pupusería', 'Hybrid — host makes some, orders the rest'], default: 'Hybrid — host makes some, orders the rest', when: 'T-7d', blocks: ['food', 'griddle'], why: 'The single biggest effort lever. Scratch is the heart of it but slow on one comal; hybrid lets the shaping stay communal while a pupusería backstops volume so nobody is stuck at the griddle all night.' },
    { id: 'fillings', label: 'Fillings spread', options: ['Revueltas only (chicharrón + cheese + beans)', 'Revueltas + queso + frijol con queso', 'Full spread incl. loroco + ayote/squash', 'Veg-friendly (queso, frijol, loroco, ayote)'], default: 'Revueltas + queso + frijol con queso', when: 'T-7d', blocks: ['food'], why: 'Drives masa, quesillo, beans, and chicharrón quantities. Revueltas is the classic; always keep a plain queso and a bean option so kids and non-pork eaters are covered.' },
    { id: 'curtido_ahead', label: 'Curtido — made ahead (it needs days)', options: ['Make 3+ days ahead (properly fermented)', 'Make 1–2 days ahead (lightly soured)', 'Buy jarred curtido'], default: 'Make 3+ days ahead (properly fermented)', when: 'T-4d', blocks: ['food'], why: 'Curtido is not a same-day side — it needs to sour. Decide early because the made-ahead option sets a hard task days before the gathering. No curtido = it is not really a pupusa table.' },
  ...
  purchases: [
    { id: 'p_masa', item: 'Masa (instant corn masa harina or fresh masa)', category: 'food', qtyPerGuest: 0.7, unit: 'lb', where: ['Latin market', 'Grocery', 'Tortillería'], unitCostRange: [1, 3], essential: true, buyAt: 'T-3d', note: '~3–4 pupusas/adult; ~0.15–0.2 lb masa each. Fresh masa from a tortillería shapes best if you can get it.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: '3–4 pupusas/adult × ~0.15–0.2 lb masa/pupusa.' } },
    { id: 'p_quesillo', item: 'Quesillo (Salvadoran melting cheese) or mozzarella blend', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Latin market', 'Grocery'], unitCostRange: [4, 7], essential: true, buyAt: 'T-3d', note: 'Quesillo is the soul of queso + revueltas pupusas. Mozzarella/Oaxaca is the common DMV substitute.' },
    { id: 'p_chicharron', item: 'Chicharrón (ground pork) for revueltas', category: 'food', qtyPerGuest: 0.15, unit: 'lb', where: ['Latin market', 'Butcher'], unitCostRange: [4, 8], essential: false, buyAt: 'T-3d', note: 'Ground/cooked pork for revueltas. Skip for the veg-friendly spread.' },
    { id: 'p_beans', item: 'Refried beans (frijoles molidos) for frijol con queso', category: 'food', qtyPerGuest: 0.2, unit: 'lb', where: ['Latin market', 'Grocery'], unitCostRange: [1.5, 3], essential: true, buyAt: 'T-3d', note: 'Frijol con queso is the everyone-can-eat-it pupusa — always have it.' },
