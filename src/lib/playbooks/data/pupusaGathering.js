...
const pupusaGathering = {
  ...
  purchases: [
    ...
    { id: 'p_beer', item: 'Beer (Pilsener / Suprema) or sodas — grown/all-ages section', category: 'beverage', qtyPerGuest: 2, unit: 'drinks', where: ['Latin market', 'Liquor store', 'Grocery'], unitCostRange: [1, 3], essential: false, buyAt: 'T-3d', note: 'Salvadoran Pilsener/Suprema if you can find them; sodas (Kolashampan) keep it all-ages.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_tableware', item: 'Plates, napkins, forks (sturdy — pupusas are hot + greasy)', category: 'rental', qtyPerGuest: 2, unit: 'set', where: ['Grocery', 'Costco', 'Party store'], unitCostRange: [0.2, 0.6], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_cleanup', item: 'Trash bags, paper towels, foil + containers for leftovers', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [6, 12], essential: true, buyAt: 'T-3d', note: 'Foil/containers to send pupusas home — guests will ask. Paper towels for the greasy comal.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
