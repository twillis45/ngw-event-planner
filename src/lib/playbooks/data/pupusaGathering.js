...
const pupusaGathering = {
  ...
  purchases: [
    ...
    { id: 'p_quesillo', item: 'Quesillo (Salvadoran melting cheese) or mozzarella blend', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Latin market', 'Grocery'], unitCostRange: [4, 7], essential: true, buyAt: 'T-3d', note: 'Quesillo is the soul of queso + revueltas pupusas. Mozzarella/Oaxaca is the common DMV substitute.', alternatives: ['Whole-milk mozzarella — widely available substitute, melts similarly', 'Oaxacan cheese — closer to quesillo, often found at Latin markets'] , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
