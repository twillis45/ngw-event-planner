...
const graduation = {
  ...
  decisions: [
    { id: 'food_style', label: 'How is the food handled?', options: ['Host cooks / grills', 'Drop-off catering / BBQ', 'Potluck', 'Order trays'], default: 'Host cooks / grills', when: 'T-21d', blocks: ['food', 'vendors'], costFactors: { 'Drop-off catering / BBQ': 1.3, 'Potluck': 0.55, 'Order trays': 1.1 }, affects: ['p_food'], why: 'An open house with churn wants self-serve food that holds — easy to host-make and over-provision, or a drop-off if the day is busy.' },
    { id: 'format', label: 'Open house or set-time party?', options: ['Open house (drop-in)', 'Set-time party', 'Joint party (multiple grads)'], default: 'Open house (drop-in)', when: 'T-21d', blocks: ['food', 'tableware'], costFactors: { 'Set-time party': 0.9, 'Joint party (multiple grads)': 1.1 }, affects: ['p_food'], why: 'Open houses see more total heads with churn — plan self-serve food that holds, and over-provision.' },
    ...
    { id: 'food_menu', label: 'Food style', options: ['BBQ / grill', 'Buffet / trays', 'Drop-off catering', 'Taco/food bar'], default: 'Buffet / trays', when: 'T-14d', blocks: ['food', 'vendors'], costFactors: { 'BBQ / grill': 1.1, 'Drop-off catering': 1.3, 'Taco/food bar': 0.95 }, affects: ['p_food'], why: 'Self-serve buffet or BBQ that holds beats plated for a drop-in crowd.' },
