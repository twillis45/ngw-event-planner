...
const graduation = {
  ...
  purchases: [
    ...
    { id: 'p_decor', item: 'Decor (school colors, banner, balloons, table covers)', category: 'decor', qtyFlat: 1, unit: 'kit', where: ['Party store', 'Amazon', 'Target'], unitCostRange: [30, 80], essential: false, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
