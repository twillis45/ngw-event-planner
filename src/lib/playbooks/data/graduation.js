...
const graduation = {
  ...
  purchases: [
    ...
    { id: 'p_drinks', item: 'Soft drinks, water, lemonade', category: 'beverage', qtyPerGuest: 3, unit: 'drinks', where: ['Grocery', 'Costco'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~3 drinks/guest over a multi-hour open house.' } },
