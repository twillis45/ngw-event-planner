...
const graduation = {
  ...
  purchases: [
    ...
    { id: 'p_drinks', item: 'Soft drinks, water, lemonade', category: 'beverage', qtyPerGuest: 4, unit: 'drinks', where: ['Grocery', 'Costco'], unitCostRange: [1, 2], essential: true, buyAt: 'T-3d', note: 'Board-corrected up from 3: an outdoor open house with drop-in churn + summer heat runs ~1 drink/guest/hour.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~1 drink/guest/hour ≈ 4/guest over a 4h outdoor open house.', claim: '~4 drinks per guest over a 4-hour outdoor graduation open house, at ~1 drink per guest per hour', sufficientWhen: 'verified — board-corrected up from 3 for an outdoor summer event; established-consensus that outdoor heat drives ~1 drink/guest/hour' } },
