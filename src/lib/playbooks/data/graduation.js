...
const graduation = {
  ...
  purchases: [
    ...
    { id: 'p_signs', item: 'Custom yard sign + photo prints / banner', category: 'decor', qtyFlat: 1, unit: 'set', where: ['Print shop', 'Staples', 'Online'], unitCostRange: [20, 50], essential: false, buyAt: 'T-3d', dependsOnDecision: 'display', note: 'Order early — custom prints have lead time.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
