...
const graduation = {
  ...
  purchases: [
    ...
    { id: 'p_alcohol', item: 'Beer / wine (adults only)', category: 'beverage', qtyPerGuest: 1.5, unit: 'drinks', where: ['Liquor store', 'Grocery'], unitCostRange: [3, 6], essential: false, buyAt: 'T-3d', dependsOnDecision: 'alcohol' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_ice', item: 'Ice', category: 'beverage', qtyPerGuest: 2, unit: 'lb', where: ['Grocery', 'Gas station'], unitCostRange: [0.2, 0.4], essential: true, buyAt: 'T0', note: 'COMMONLY FORGOTTEN. Board-corrected to ~2 lb/guest — this is an OUTDOOR event (matches the BBQ playbook); ice melts faster in the heat.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'established-consensus', note: '~2 lb ice/guest for outdoor beverage service (heat-adjusted).', claim: '~2 lb of ice per guest is appropriate for an outdoor summer graduation party where heat accelerates melting', sufficientWhen: 'verified — established-consensus for outdoor summer event ice planning; consistent with heat-adjusted US hosting heuristics (1.5–2 lb outdoor, 1 lb indoor)' } },
    ...
    { id: 'p_favors', item: 'Favors / giveaways', category: 'decor', qtyPerGuest: 1, unit: 'favor', where: ['Party store', 'Amazon'], unitCostRange: [2, 6], essential: false, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_tableware', item: 'Plates, cups, napkins, cutlery + table covers', category: 'rental', qtyPerGuest: 1.5, unit: 'set', where: ['Grocery', 'Costco', 'Party store'], unitCostRange: [0.5, 1.5], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_cups', item: 'Disposable cups (self-serve drinks)', category: 'logistics', qtyPerGuest: 4, unit: 'cup', where: ['Grocery', 'Costco', 'Party store'], unitCostRange: [0.05, 0.15], essential: true, buyAt: 'T-3d', note: 'Board add: at ~4 self-serve drinks/guest, CUPS run out first — people grab a fresh one each refill. Plate "sets" do not cover it.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_paper', item: 'Paper goods (foil, serving utensils, leftover + card box)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Costco'], unitCostRange: [10, 20], essential: true, buyAt: 'T-3d', note: 'COMMONLY FORGOTTEN: serving spoons/tongs for the buffet + a card/gift box.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_cleanup', item: 'Trash + recycling bags, paper towels, wipes', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [8, 15], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
