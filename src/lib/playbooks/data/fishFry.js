...
const fishFry = {
  ...
  purchases: [
    { id: 'p_fish', item: 'Fresh fish (whiting, catfish, porgies)', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Seafood market', 'Grocery', 'Asian/ethnic market'], unitCostRange: [3, 7], essential: true, buyAt: 'T-1d', note: 'The whole point. ~0.5 lb/person whole or filleted. Whiting is the value pick; catfish the classic.', provenance: { tier: 'trade-heuristic', confidence: 'medium', verificationStatus: 'synthesized', note: '~0.5 lb fish/guest fish-fry serving heuristic.' } },
    ...
    { id: 'p_hotsauce', item: 'Hot sauce + fresh lemons', category: 'food', qtyPerGuest: 0.15, unit: 'serving', where: ['Grocery'], unitCostRange: [0.3, 0.8], essential: true, buyAt: 'T-3d', note: 'NON-NEGOTIABLE. Hot sauce (Louisiana/Crystal/Texas Pete) and a squeeze of lemon over the fish — every plate.' },
    { id: 'p_bread', item: 'White bread (loaves)', category: 'food', qtyPerGuest: 2, unit: 'slices', where: ['Grocery'], unitCostRange: [0.05, 0.1], essential: true, buyAt: 'T-1d', note: 'White bread makes the fish into a sandwich — soaks the grease, holds the hot sauce. A fish-fry constant.' },
    { id: 'p_starch', item: 'Spaghetti + red sauce OR grits', category: 'food', qtyPerGuest: 0.25, unit: 'lb', where: ['Grocery'], unitCostRange: [0.5, 1.2], essential: true, buyAt: 'T-3d', note: 'Fried fish + spaghetti is the signature pairing; grits the breakfast-fish version.' },
    { id: 'p_sides', item: 'Coleslaw, potato salad, hush puppy mix, fries', category: 'food', qtyPerGuest: 0.5, unit: 'lb', where: ['Grocery'], unitCostRange: [1.5, 3.5], essential: true, buyAt: 'T-1d', note: 'Cabbage/carrot for slaw, potatoes for salad + fries, cornmeal hush puppy batter (fry the puppies in the same oil between fish batches).' },
