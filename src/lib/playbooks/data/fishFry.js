...
const fishFry = {
  ...
  decisions: [
    ...
    { id: 'fish', label: 'The fish', options: ['Whiting', 'Catfish', 'Porgies', 'Whiting + catfish mix'], default: 'Whiting + catfish mix', when: 'T-10d', blocks: ['food'], costFactors: { 'Whiting': 0.85, 'Catfish': 1.1, 'Porgies': 1.05 }, affects: ['p_fish'], why: 'Whiting is the affordable crowd favorite; catfish is the Deep-South classic; porgies fry up sweet. A mix lets people pick. All get a seasoned cornmeal dredge.' },
    { id: 'starch', label: 'The starch side — spaghetti or grits?', options: ['Spaghetti (red sauce)', 'Grits', 'Both', 'Fries only'], default: 'Spaghetti (red sauce)', when: 'T-10d', blocks: ['food'], costFactors: { 'Grits': 0.95, 'Both': 1.3, 'Fries only': 0.8 }, affects: ['p_starch'], why: 'Fried fish and spaghetti is the signature Black-Southern pairing; grits is the breakfast-fish tradition. Either way the white bread stays — it makes the fish sandwich.' },
    { id: 'drinks', label: 'Drinks', options: ['Sweet tea + red drink + soda + water', 'Add a grown section (beer/brown liquor)', 'Family-friendly / dry'], default: 'Sweet tea + red drink + soda + water', when: 'T-7d', blocks: ['beverage'], costFactors: { 'Add a grown section (beer/brown liquor)': 1.35 }, affects: ['p_drinks'], why: 'Sweet tea and red drink are the table. A grown section for the adults is optional; a fundraiser usually stays dry to keep it church-friendly.' },
