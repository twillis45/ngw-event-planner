...
const conference = {
  ...
  purchases: [
    ...
    { id: 'p_swag', item: 'Swag bags + contents (notebook, pen, water bottle)', category: 'logistics', qtyPerGuest: 1, unit: 'bag', where: ['Promo vendor', 'Sponsor-supplied'], unitCostRange: [5, 25], essential: false, buyAt: 'T-3d', note: 'Frequently sponsor-funded or sponsor-branded; confirm who pays + who fills the bags.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_reg_supplies', item: 'Registration desk kit (printers, scanners, badge stock, signage, supplies)', category: 'logistics', qtyFlat: 1, unit: 'kit', where: ['Registration vendor', 'Office supply'], unitCostRange: [300, 1500], essential: true, buyAt: 'T-1d', note: 'On-site badge printing, scanners, power strips, extension cords, gaff tape, sharpies, scissors.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    { id: 'p_water_stage', item: 'Speaker/stage hospitality (bottled water, throat lozenges, stage snacks)', category: 'beverage', qtyFlat: 1, unit: 'kit', where: ['Grocery', 'Venue F&B'], unitCostRange: [40, 150], essential: false, buyAt: 'T-1d', note: 'Green-room + stage water for speakers; most attendee F&B is on the BEO, not bought.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
