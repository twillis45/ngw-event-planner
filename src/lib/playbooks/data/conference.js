...
const conference = {
  ...
  purchases: [
    ...
    { id: 'p_programs', item: 'Printed programs / pocket agenda', category: 'logistics', qtyPerGuest: 1, unit: 'program', where: ['Print shop'], unitCostRange: [1, 4], essential: false, buyAt: 'T-3d', note: 'Often replaced by the attendee app; print a short pocket card or signage if going app-only.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
