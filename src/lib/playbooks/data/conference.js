...
const conference = {
  ...
  purchases: [
    { id: 'p_badges', item: 'Attendee badges + lanyards', category: 'logistics', qtyPerGuest: 1, unit: 'badge', where: ['Registration vendor', 'Print shop', 'Amazon'], unitCostRange: [1.5, 5], essential: true, buyAt: 'T-3d', note: 'Order ~10% over final count for walk-ins, reprints, staff, and VIP/speaker ribbons.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
