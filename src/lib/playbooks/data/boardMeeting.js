...
const boardMeeting = {
  ...
  decisions: [
    ...
    { id: 'catering_level', label: 'Catering level', options: ['Coffee + water only', 'Continental breakfast', 'Working lunch (boxed/buffet)', 'None — directors on their own'], default: 'Coffee + water only', defaultWhy: 'Coffee and water is the default because it fits a session that does not cross a mealtime, and over-catering reads wrong for a governance meeting. Change it to a working lunch if the agenda runs across midday — directors who skip a meal for a long session leave hungry and distracted.', when: 'T-14d', dependsOn: ['format'], blocks: ['catering'], weight: 'low', reversibility: 'reversible', emotionalWeight: 'low', difmCapable: 'can-derive', priorityBasis: { rationale: 'Coffee or a working lunch is the lowest-stakes call here — tie it to the meeting length and keep it functional, never festive.', tier: 'reasoned' }, why: 'Keep it functional, not festive. Tie the level to the meeting length and time of day — coffee for a short morning session, a working lunch only if it runs across midday. Over-catering reads wrong for governance.' },
  ],
