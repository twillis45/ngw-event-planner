...
const ethiopianCoffeeCeremony = {
  ...
  purchases: [
    ...
    { id: 'p_cini', item: 'Cini / sini cups (small handle-less coffee cups)', category: 'rental', qtyFlat: 2, qtyPer: 1, unit: 'cups', where: ['Ethiopian market', 'Online'], unitCostRange: [1.5, 4], essential: true, buyAt: 'T-3d', note: 'Small handle-less cups, often on a decorated tray (rekebot). Buy a couple extra for spares.' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
    ...
    { id: 'p_cleanup', item: 'Trash bags, paper towels, dish soap, leftover containers', category: 'cleanup', qtyFlat: 1, unit: 'kit', where: ['Grocery'], unitCostRange: [8, 15], essential: true, buyAt: 'T-3d' , provenance: { tier: 'estimate', confidence: 'low', verificationStatus: 'synthesized' } },
  ],
