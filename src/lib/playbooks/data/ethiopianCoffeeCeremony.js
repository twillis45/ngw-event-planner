...
const ethiopianCoffeeCeremony = {
  ...
  purchases: [
    ...
    { id: 'p_injera', item: 'Injera (teff sourdough flatbread)', category: 'food', qtyPerGuest: 3, unit: 'rounds', where: ['Ethiopian market', 'Ethiopian restaurant'], unitCostRange: [1, 2.5], essential: true, buyAt: 'T0', note: 'Buying is normal and smart. ~2–3 rounds per eater — it is the plate AND the utensil (eaten by hand). DC-area markets/restaurants sell it fresh.', provenance: { tier: 'matriarch', confidence: 'medium', verificationStatus: 'synthesized', note: 'Injera as plate-and-utensil; ~2–3 rounds/eater is a common serving norm.' } },
    { id: 'p_meatwat', item: 'Doro wat / key (sega) wat ingredients — chicken or beef, eggs, onion', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Halal butcher', 'Ethiopian market'], unitCostRange: [3, 7], essential: false, buyAt: 'T-1d', note: 'Doro wat = chicken in berbere with a hard-boiled egg, the festive centerpiece. ~0.4 lb wat per eater. Skip entirely on a fasting day.', provenance: { tier: 'matriarch', confidence: 'medium', verificationStatus: 'synthesized', note: '~0.4 lb wat/eater common serving heuristic.' } },
    { id: 'p_veganwat', item: 'Vegan fasting (ye-tsom) wat — shiro flour, red lentils (misir), collards/kale (gomen)', category: 'food', qtyPerGuest: 0.4, unit: 'lb', where: ['Grocery', 'Ethiopian market'], unitCostRange: [2, 5], essential: true, buyAt: 'T-1d', note: 'ALWAYS include. Shiro (chickpea), misir (red lentil), gomen (greens) — cooked in oil, not niter kibbeh, to keep them truly fasting-safe.', provenance: { tier: 'culture-bearer', confidence: 'medium', verificationStatus: 'synthesized', note: 'Vegan ye-tsom spread is central; true fasting dishes use oil not spiced butter.' } },
    ...
    { id: 'p_fandisha', item: 'Popcorn (fandisha) + bread (himbasha)', category: 'food', qtyPerGuest: 1, unit: 'serving', where: ['Grocery', 'Ethiopian market'], unitCostRange: [0.5, 2], essential: true, buyAt: 'T-1d', note: 'Popcorn and lightly sweet himbasha are served alongside the coffee — a small snack with each round.' },
