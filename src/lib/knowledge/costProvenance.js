...
export const COST_SOURCES = {
  ...
  // ── WAVE 7 (registered 2026-08-18) ──────────────────────────────────────
  'salad-kroger-2026': {
    org: 'Kroger.com — Kroger Traditional Macaroni Salad, 48oz',
    url: 'https://www.kroger.com/q/pasta+salad',
    fetched: '2026-08-18',
    claim: 'Kroger 48oz macaroni salad $3.99 (~$1.33/lb).',
  },
  'salad-walmart-2026': {
    org: 'Walmart.com — Freshness Guaranteed Garden Pasta Salad, 14oz',
    url: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Walmart 14oz garden pasta salad $3.74 (~$4.27/lb). No retailer publishes an online per-lb deli-counter salad price with a stated serving count, so this and salad-kroger-2026 cover packaged tub salad only.',
  },
  'veggietray-publix-2026': {
    org: 'Publix.com — Deli Garden Fresh Vegetable Platter, Large (112oz, serves 26-30)',
    url: 'https://delivery.publix.com',
    fetched: '2026-08-18',
    claim: 'Publix large veggie platter, 112oz, $41.99, explicitly stated to serve 26-30 (~$1.40-1.60/person).',
  },
  'veggietray-krogerwalmart-2026': {
    org: 'Kroger.com and Walmart.com — 40oz veggie trays',
    url: 'https://www.kroger.com',
    corroboratingUrl: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Kroger and Walmart 40oz trays run $11.97-12.99 without a stated headcount (~8-12 people estimated, not retailer-confirmed) — corroborates veggietray-publix-2026 in the same per-person range.',
  },
  'salsa-costco-2026': {
    org: 'Costco.com — Tostitos Chunky Salsa 2-pack (40.575oz each)',
    url: 'https://www.costco.com',
    fetched: '2026-08-18',
    claim: 'Costco 2-pack $9.99 for 81.15oz total (~$0.12/oz).',
  },
  'salsa-walmart-2026': {
    org: 'Walmart.com — Great Value Thick and Chunky Salsa 16oz',
    url: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Walmart single 16oz jar $1.97 (~$0.13/oz) — corroborates salsa-costco-2026 tightly despite very different pack sizes.',
  },
  'koozies-tahoebay-2026': {
    org: 'TahoeBay (direct) — blank neoprene can coolers',
    url: 'https://tahoebay.com/products/standard-size-neoprene-can-coolers',
    fetched: '2026-08-18',
    claim: 'Blank neoprene koozies, $1.44/unit base price (25-pack), dropping to $0.86-1.12/unit at bulk quantities.',
  },
  'koozies-wholesalecoolies-2026': {
    org: 'Wholesale Coolies (direct) — blank neoprene can coolers',
    url: 'https://wholesalecoolies.com/product/blank-neoprene-collapsible-can-koozie/',
    fetched: '2026-08-18',
    claim: 'Blank neoprene koozie, $1.44/unit — corroborates koozies-tahoebay-2026 exactly. Bottle opener pricing was NOT independently corroborated in this pass (only one search-snippet source, Michaels) and is excluded from this figure.',
  },
  'genderrevealboard-zurchers-2026': {
    org: 'Zurchers (direct) — Gender Reveal Tally Board & Stickers',
    url: 'https://zurchers.com/products/gender-reveal-tally-board-and-stickers-1932151',
    fetched: '2026-08-18',
    claim: 'Gender reveal tally board + stickers, $6.37.',
  },
  'genderrevealboard-proloso-2026': {
    org: 'PROLOSO (direct, brand site) — voting board, same product line/format',
    url: 'https://proloso.com',
    fetched: '2026-08-18',
    claim: 'Voting board (same brand/format line, though the "Buck or Doe" variant rather than the exact "Team Pink/Team Blue" SKU) $9.99 — corroborates genderrevealboard-zurchers-2026 within a $6-10 range for a board + sticker set.',
  },
  'boilseasoning-smallbox-2026': {
    org: 'Target (direct fetch, prior pass) and Kroger listings for Zatarain\'s Crawfish/Shrimp/Crab Boil, 3oz box',
    url: 'https://www.target.com',
    corroboratingUrl: 'https://www.kroger.com',
    fetched: '2026-08-18',
    claim: 'Zatarain\'s 3oz boil-seasoning box: Target $1.99, Kroger $1.89-2.49 (multi-location range). About $10-13/lb at this small format.',
  },
  'boilseasoning-smallbox-walmart-2026': {
    org: 'Walmart listing for Zatarain\'s Crawfish/Shrimp/Crab Boil, 3oz box',
    url: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Zatarain\'s 3oz boil-seasoning box, ~$1.97 — a third independent retailer confirming boilseasoning-smallbox-2026.',
  },
  'boilseasoning-bulk-2026': {
    org: 'SpicePlace (direct listing) — Zatarain\'s 4.5lb bag',
    url: 'https://www.spiceplace.com/zatarains-crab-boil-sack-size.php',
    fetched: '2026-08-18',
    claim: 'Bulk 4.5lb Zatarain\'s bag, $11.34 (~$2.52/lb).',
  },
  'boilseasoning-bulk-amazon-2026': {
    org: 'Amazon — Louisiana Fish Fry 4.5lb, 6-pack case (same size class, different brand)',
    url: 'https://www.amazon.com',
    fetched: '2026-08-18',
    claim: 'Louisiana Fish Fry case-unit price ~$10.80-12.00 for 4.5lb (~$2.40-2.67/lb) — corroborates boilseasoning-bulk-2026 on the bulk-format tier. A conflicting Target listing at $5.49 for the same size is flagged as a likely data error (does not match any other 4.5lb figure) and excluded.',
  },
  'sugar-walmart-2026': {
    org: 'Walmart — private-label granulated sugar, 4lb bag',
    url: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Walmart Great Value granulated sugar, 4lb, $2.97-3.24.',
  },
  'sugar-target-2026': {
    org: 'Target — Good & Gather granulated sugar, 4lb bag',
    url: 'https://www.target.com',
    corroboratingUrl: 'https://www.kroger.com',
    fetched: '2026-08-18',
    claim: 'Target $3.39; Kroger $4.99 — both corroborate sugar-walmart-2026 for a 4lb bag of granulated sugar, tighter band at the two lowest ($2.97-3.39).',
  },
  ...
  // ── WAVE 8 (registered 2026-08-18) ──────────────────────────────────────
  'pizzamains-costco-2026': {
    org: 'Various publishers on Costco deli platters (thekrazycouponlady.com, costcocatering.net)',
    url: 'https://thekrazycouponlady.com',
    fetched: '2026-08-18',
    claim: 'Costco deli platters: $18.99-$40+/platter, averaging $1.67-$3.75/serving.',
  },
  'pizzamains-papajohns-2026': {
    org: "Papa John's catering — large pizza and classics menu",
    url: 'https://www.papajohns.com/catering',
    fetched: '2026-08-18',
    claim: "Papa John's: large pizza (feeds 3-4) $17.99, classics from $10.99 (~$4.50-5.50/serving). A second independent format tier confirming pizzamains-costco-2026's per-serving range for party mains.",
  },
  'sweet16cake-costco-2026': {
    org: 'Costco — half-sheet cake (serves 48) and 10" round cake',
    url: 'https://www.costco.com',
    fetched: '2026-08-18',
    claim: 'Costco half-sheet cake $27.99 (serves 48, ~$0.58/serving); 10" round $17.99.',
  },
  'sweet16cake-walmart-2026': {
    org: 'Walmart — quarter-sheet cake (serves ~24)',
    url: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Walmart quarter-sheet cake $19.96-$38 depending on decoration (serves ~24) — a second independent retailer confirming sweet16cake-costco-2026 in the same low-per-serving range for a party sheet cake.',
  },
  'chicken-bls-2026': {
    org: 'FRED (St. Louis Fed) — BLS Average Price series APU0000706111, fresh whole chicken',
    url: 'https://fred.stlouisfed.org/series/APU0000706111',
    fetched: '2026-08-18',
    claim: 'U.S. average retail fresh whole chicken, July 2026, $2.01/lb.',
  },
  'chicken-walmart-2026': {
    org: 'Walmart.com — Tyson All Natural Fresh Premium Young Whole Chicken',
    url: 'https://www.walmart.com/browse/food/whole-chicken',
    fetched: '2026-08-18',
    claim: 'Whole chicken $1.46/lb (5-7lb size), $1.32/lb (10-14lb twin pack) — a second independent source confirming chicken-bls-2026 in the same low-per-lb range for a whole bird.',
  },
  'greens-walmart-2026': {
    org: 'Walmart.com — Fresh Collard Greens Bunch',
    url: 'https://www.walmart.com/ip/Fresh-Collard-Greens-Bunch-Each/44391317',
    fetched: '2026-08-18',
    claim: 'Fresh collard greens, per bunch, $1.57-$2.47.',
  },
  'greens-kroger-2026': {
    org: 'Kroger.com — Jumbo Collard Greens Bunch',
    url: 'https://www.kroger.com/p/jumbo-collard-greens-bunch/0000000004614',
    fetched: '2026-08-18',
    claim: 'Fresh collard greens, per bunch, $2.99 everyday price (regionally to $3.19) — a second independent retailer confirming greens-walmart-2026.',
  },
  'candles-sevensymbols-2026': {
    org: 'Seven Symbols of Kwanzaa — mishumaa saba (7-candle set)',
    url: 'https://sevensymbolsofkwanzaa.com',
    fetched: '2026-08-18',
    claim: 'Seven Kwanzaa candle set (mishumaa saba), $17.00.',
  },
  'candles-michaels-2026': {
    org: 'Michaels — 14-candle Kwanzaa candle set',
    url: 'https://www.michaels.com',
    fetched: '2026-08-18',
    claim: '14-candle set $33.97 (~$17/7-candle equivalent) — a second independent retailer confirming candles-sevensymbols-2026.',
  },
  'mkeka-africaimports-2026': {
    org: 'Africa Imports — mkeka woven mat, 18"x12"',
    url: 'https://www.africaimports.com',
    fetched: '2026-08-18',
    claim: 'Mkeka (woven mat), 18"x12", $7.90.',
  },
  'mkeka-7principles-2026': {
    org: '7 Principles 365 — mkeka woven mat, 16"x13"',
    url: 'https://www.7principles365.com',
    fetched: '2026-08-18',
    claim: 'Mkeka (woven mat), 16"x13", $14.99 sale/$19.99 regular — a second independent retailer confirming mkeka-africaimports-2026 in the same low-teens range.',
  },
  'unitycup-7principles-2026': {
    org: '7 Principles 365 — kikombe cha umoja (hand-carved wood unity cup)',
    url: 'https://www.7principles365.com',
    fetched: '2026-08-18',
    claim: 'Unity cup, hand-carved wood, $17.99.',
  },
  'unitycup-africanheritage-2026': {
    org: 'African Heritage Collection — kikombe cha umoja (Ghana-made unity cup)',
    url: 'https://www.africanheritagecollection.com',
    fetched: '2026-08-18',
    claim: 'Unity cup, Ghana-made, $13.95 sale/$22.95 regular — a second independent retailer confirming unitycup-7principles-2026 in the same range.',
  },
  'oxtail-costco-2026': {
    org: 'Costco — oxtail, per lb',
    url: 'https://www.costco.com',
    fetched: '2026-08-18',
    claim: 'Oxtail, per lb at a warehouse club, $7.79.',
  },
  'oxtail-publix-2026': {
    org: 'Publix — oxtail, per lb',
    url: 'https://www.publix.com',
    fetched: '2026-08-18',
    claim: 'Oxtail, $24.38/lb — a second independent retailer; the spread (Costco warehouse vs. Publix supermarket) is real and channel-driven, not an error.',
  },
  'halfsmokes-meatcrafters-2026': {
    org: 'MeatCrafters (official brand site) — Capital Half Smokes',
    url: 'https://meatcrafters.com/products/capital-half-smokes-pork-sausage',
    fetched: '2026-08-18',
    claim: 'MeatCrafters Capital Half Smokes, $14.99 (14oz pack, 4 links).',
  },
  'halfsmokes-marketriverfalls-2026': {
    org: 'The Market at River Falls (independent grocer) — MeatCrafters Halfsmoke',
    url: 'https://www.marketriverfalls.com',
    fetched: '2026-08-18',
    claim: 'MeatCrafters Halfsmoke, $13.99 each — a second independent retailer confirming halfsmokes-meatcrafters-2026, same brand.',
  },
  'redvelvet-samsclub-2026': {
    org: "Sam's Club (Member's Mark) — 10\" round red velvet cake",
    url: 'https://www.samsclub.com/p/red-velvet-round-cake/prod20630613',
    fetched: '2026-08-18',
    claim: 'Red velvet cake, 10" round, 92oz, $19.98 (~$3.47/lb).',
  },
  'redvelvet-publix-2026': {
    org: 'Publix — red velvet cake, 50oz',
    url: 'https://delivery.publix.com/store/publix/products/3137199-red-velvet-cake-50-oz',
    fetched: '2026-08-18',
    claim: 'Red velvet cake, 50oz, $29.99 (~$9.60/lb) — a second independent retailer confirming redvelvet-samsclub-2026, at a supermarket-bakery price tier above the club-cake tier.',
  },
  'watermelon-kroger-2026': {
    org: 'Kroger.com — whole watermelon',
    url: 'https://www.kroger.com/q/watermelon',
    fetched: '2026-08-18',
    claim: 'Whole watermelon: seedless $5.99, seeded $5.00, mini seedless $4.19.',
  },
  'watermelon-walmart-2026': {
    org: 'Walmart.com — whole watermelon',
    url: 'https://www.walmart.com',
    fetched: '2026-08-18',
    claim: 'Whole watermelon: seedless $9.42, seeded $6.87, mini seedless $4.48 — a second independent retailer confirming watermelon-kroger-2026.',
  },
  'watermelon-selinawamucii-2026': {
    org: 'Selina Wamucii market price index — US watermelon average',
    url: 'https://www.selinawamucii.com/insights/prices/united-states-of-america/watermelon',
    fetched: '2026-08-18',
    claim: 'US average watermelon price, ~$0.53/lb, August 2026 — a third corroborating source at the per-lb level.',
  },
  'retirementdrink-colonialspirits-2026': {
    org: 'Colonial Spirits (Acton, MA) — Sierra Nevada Pale Ale 6-pack',
    url: 'https://colonialspirits.com',
    fetched: '2026-08-18',
    claim: 'Craft beer 6-pack (12oz bottles), $13.19 + $0.30 bottle deposit.',
  },
  'retirementdrink-target-2026': {
    org: 'Target — Sierra Nevada Pale Ale 6-pack',
    url: 'https://www.target.com/p/sierra-nevada-pale-ale-beer-6pk-12-fl-oz-bottles/-/A-13392267',
    fetched: '2026-08-18',
    claim: 'Craft beer 6-pack, $11.99 sale ($12.99 reg) — a second independent retailer confirming retirementdrink-colonialspirits-2026 within $11.99-13.49.',
  },
  'retirementwine-applejack-2026': {
    org: 'Applejack Wine & Spirits — Kendall-Jackson Vintner\'s Reserve Chardonnay',
    url: 'https://www.applejack.com',
    fetched: '2026-08-18',
    claim: 'Mid-range red or white wine, 750ml bottle, $10.98.',
  },
  'retirementwine-winesearcher-2026': {
    org: 'Wine-Searcher price aggregator and Wine On Sale — Kendall-Jackson Chardonnay',
    url: 'https://www.wine-searcher.com',
    fetched: '2026-08-18',
    claim: 'Mid-range wine, 750ml, average ~$16 (Wine-Searcher), $17.95 (Wine On Sale) — a second independent source confirming a real $10.98-17.95 spread for mid-range wine.',
  },
  'crabs-buylivecrab-2026': {
    org: 'BuyLiveCrab.com — live blue crabs, per lb',
    url: 'https://buylivecrab.com/store-1/p/blue-crab-10lbs',
    fetched: '2026-08-18',
    claim: 'Live blue crabs, $4.25/lb, 45lb minimum order — a second independent source confirming the existing Dockside Blue Crabs bushel pricing at the per-lb level.',
  },
  'jebena-ancientcookware-2026': {
    org: 'Ancient Cookware — Ethiopian clay jebena coffee pot',
    url: 'https://www.ancientcookware.com/ethiopian-collection/ethiopian-clay-jebena-coffee-pot-detail',
    fetched: '2026-08-18',
    claim: 'Jebena, small (7oz) $44.99, medium (12oz) $54.99, large (24oz) $64.99.',
  },
  'jebena-ethiopiancoffeepot-2026': {
    org: 'Ethiopian Coffee Pot (ethiopiancoffeepot.com) — handmade clay jebena',
    url: 'https://www.ethiopiancoffeepot.com',
    fetched: '2026-08-18',
    claim: 'Handmade jebena, 16oz, $45 — a second independent retailer confirming jebena-ancientcookware-2026 in the same $45-65 range.',
  },
  'injera-zalamarket-2026': {
    org: 'Zala Market — Ethiopian white teff injera',
    url: 'https://www.zala-market.com/products/ethiopian-white-teff-injera-flatbread',
    fetched: '2026-08-18',
    claim: 'Injera, 5 pieces (40.74oz total), $10.00 (~$2.00/piece).',
  },
  'injera-ethiopianspices-2026': {
    org: 'Ethiopian Spices — teff injera',
    url: 'https://ethiopianspices.com/products/injera',
    fetched: '2026-08-18',
    claim: 'Injera, 10 pieces (~14" each), $9.95 (~$1.00/piece), gluten-free version $14.95 — a second independent retailer; the 2x per-piece spread vs. zala-market-2026 likely reflects package/quality tier, both real prices.',
  },
  'florals-weddingwire-2026': {
    org: 'WeddingWire forum — floral centerpiece cost thread',
    url: 'https://www.weddingwire.com/wedding-forums/how-much-does-a-typical-floral-centerpiece-cost/9ef62fad0c230a16.html',
    fetched: '2026-08-18',
    claim: 'Per-centerpiece retail pricing: tall centerpieces $200-300, elevated $90-175, small bouquets ~$38 (flowers only).',
  },
  'florals-fiftyflowers-2026': {
    org: 'FiftyFlowers — wholesale centerpiece pricing',
    url: 'https://fiftyflowers.com/collections/wholesale-centerpieces',
    fetched: '2026-08-18',
    claim: 'Wholesale bulk centerpieces, under $100 to over $300 per piece — a second independent source (wholesale channel) confirming florals-weddingwire-2026 spans a similar per-piece range.',
  },
  'recuerdos-partyfavorsource-2026': {
    org: 'PartyFavorSource.com — personalized pint glass favor',
    url: 'https://partyfavorsource.com/quinceanera-sweet-16-favors.html',
    fetched: '2026-08-18',
    claim: 'Personalized 16oz pint glass favor, best bulk-tier price $4.08/piece.',
  },
  'recuerdos-etsy-2026': {
    org: 'Etsy — personalized LED crystal keychain favor',
    url: 'https://www.etsy.com/listing/622867670/personalized-crystal-keychain-led-light',
    fetched: '2026-08-18',
